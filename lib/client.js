window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function imageProxyUrl(base, value) {
		...
		function imageProxyCrossOrigin(base) {
			if (typeof window === "undefined") return void 0;
			try {
				return new URL(base, window.location.href).origin === window.location.origin ? void 0 : "anonymous";
			} catch {
				return;
			}
		}
		...
		function coverUrl(row) {
			return normalizeImageUrl(firstText(row.cover_url, row.cover, row.pic, row.thumbnail_url, row.thumbnail, row.image_url));
		}
		...
		*  the backend persists + hot-reloads. */
		...
		async function fetchInitStatus(base, signal) {
			...
			const progress = currentStage && typeof currentStage.progress === "object" && currentStage.progress !== null ? currentStage.progress : null;
			return {
				initialized: row.initialized === true,
		...
		async function fetchDiagnosticsAlerts(base, limit = 50, signal) {
			const data = await requestJson(base, `/api/diagnostics/alerts?limit=${Math.max(1, Math.min(Math.trunc(limit), 500))}`, {
				timeoutMs: 12e3,
				signal
			});
			const row = typeof data === "object" && data !== null ? data : {};
			const alerts = (Array.isArray(row.alerts) ? row.alerts : []).map((item) => {
				const alert = typeof item === "object" && item !== null ? item : {};
				return {
		...
		*/
		...
		var panel_module_css_default = {
			...
			"recHeaderActions": "_2AgH6G_recHeaderActions",
			...
			"syncBadgeRow": "_2AgH6G_syncBadgeRow",
			...
			"diagAlertMessage": "_2AgH6G_diagAlertMessage",
			...
			"cognitionDetailLabel": "_2AgH6G_cognitionDetailLabel",
			"sidebarButton": "_2AgH6G_sidebarButton",
			...
			"diagAlertMeta": "_2AgH6G_diagAlertMeta",
			"starCount": "_2AgH6G_starCount",
			...
			"cognitionDetail": "_2AgH6G_cognitionDetail",
			...
			"diagAlertSummary": "_2AgH6G_diagAlertSummary",
			...
			"sidebarButtonIcon": "_2AgH6G_sidebarButtonIcon",
			...
			"diagAlertBadge": "_2AgH6G_diagAlertBadge",
			...
			"diagAlertHead": "_2AgH6G_diagAlertHead",
			"updateRow": "_2AgH6G_updateRow",
			"cognitionDetails": "_2AgH6G_cognitionDetails",
			"delightHeader": "_2AgH6G_delightHeader",
			"sidebarButtonLabel": "_2AgH6G_sidebarButtonLabel",
			...
			"initPromptCopy": "_2AgH6G_initPromptCopy",
			"diagAlertList": "_2AgH6G_diagAlertList",
			...
			"syncResults": "_2AgH6G_syncResults",
			...
			"syncToolbar": "_2AgH6G_syncToolbar",
			...
			"syncLineText": "_2AgH6G_syncLineText",
			...
			"diagAlertSource": "_2AgH6G_diagAlertSource",
			"empty": "_2AgH6G_empty",
			...
			"cognitionContext": "_2AgH6G_cognitionContext",
			...
			"diagAlertItem": "_2AgH6G_diagAlertItem",
			...
			"syncInlineDetail": "_2AgH6G_syncInlineDetail",
		...
		*/
		...
		function CoverImage(props) {
			...
			if (src === "" || failedSource === src) return (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: props.fallback });
		...
		function Thumb(props) {
			...
			const media = props.url !== "" ? (0, react_jsx_runtime.jsx)(CoverImage, {
				base,
				url: props.url,
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("button", {
						...
						children: [!isText && item.cover_url !== "" ? (0, react_jsx_runtime.jsx)(CoverImage, {
							base,
							url: item.cover_url,
							fallback: (0, react_jsx_runtime.jsx)("span", {
								className: panel_module_css_default.recCoverText,
								children: item.title || item.body_text || "封面暂时加载失败"
							})
		...
		*  expands the body (reason + actions + chat composer). */
		function DelightBanner(props) {
			...
			const [saved, setSaved] = (0, react.useState)(null);
			const [failedCoverKey, setFailedCoverKey] = (0, react.useState)("");
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("button", {
						...
						children: [(0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								item.cover_url !== "" ? (0, react_jsx_runtime.jsx)(CoverImage, {
									base,
									url: item.cover_url,
								...
								!coverFailed && item.cover_url !== "" && item.delight_score > 0 ? (0, react_jsx_runtime.jsxs)("span", {
		...
		*/
		...
		function ChatView(props) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				error !== "" ? (0, react_jsx_runtime.jsx)(ErrorNote, { text: error }) : null,
				confirmations !== null && confirmations.total || confirmations.items.length > 0 ? (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsxs)("button", {
						...
						children: ["待聊确认", (0, react_jsx_runtime.jsx)("span", {
							...
							children: confirmations.total || confirmations.items.length
						})]
		...
		*/
		...
		function AdvancedTab(props) {
			...
			const setSoul = (key, value) => patch((doc) => ({
				...doc,
				soul: {
					...doc.soul,
					[key]: value
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				(0, react_jsx_runtime.jsxs)(Section, {
					...
					children: [
						(0, react_jsx_runtime.jsx)("p", {
							className: panel_module_css_default.settingsHint,
							children: "觉察 / 洞察每轮 LLM 调用的输入批量与输出 token 上限。默认按 256K 上下文模型设计；80-100K 上下文的本地模型可调小，无需改源码。"
						}),
						(0, react_jsx_runtime.jsx)(Field, {
							label: "觉察事件批量大小",
							children: (0, react_jsx_runtime.jsx)(NumInput, {
								value: soul.awarenessEventBatchSize,
								onChange: (v) => setSoul("awarenessEventBatchSize", v),
								min: 10,
								max: 900
							})
						}),
						(0, react_jsx_runtime.jsx)(Field, {
							label: "洞察笔记批量大小",
							children: (0, react_jsx_runtime.jsx)(NumInput, {
								value: soul.insightNoteBatchSize,
								onChange: (v) => setSoul("insightNoteBatchSize", v),
								min: 10,
								max: 450
							})
						}),
						(0, react_jsx_runtime.jsx)(Field, {
							label: "认知输出 token 上限",
							children: (0, react_jsx_runtime.jsx)(NumInput, {
								value: soul.cognitionMaxTokens,
								onChange: (v) => setSoul("cognitionMaxTokens", v),
								min: 1024,
								max: 128e3
							})
						})
		...
		function GeneralTab(props) {
			...
			const [reinitLlmConcurrency, setReinitLlmConcurrency] = (0, react.useState)(3);
			const [reinitInitTimeoutMinutes, setReinitInitTimeoutMinutes] = (0, react.useState)(60);
			(0, react.useEffect)(() => {
				let cancelled = false;
			...
			const reinit = (0, react.useCallback)(async () => {
				...
				try {
					...
					setInit((prev) => ({
						...
						running: true,
						currentStage: 1,
						totalStages: prev.totalStages || 4
					}));
				} catch (err) {
				...
				base,
				init,
				reinitLlmConcurrency,
				reinitInitTimeoutMinutes,
				resetCognition,
				toast
			]);
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				(0, react_jsx_runtime.jsxs)(Section, {
					...
					children: [
						(0, react_jsx_runtime.jsx)("p", {
							className: panel_module_css_default.settingsHint,
							children: !init.loaded ? "读取初始化状态中…" : init.running ? `初始化进行中（阶段 ${init.currentStage || "?"}/${init.totalStages || 4}）${init.stageNote ? ` · ${init.stageNote}` : ""}。请等待完成后再重新初始化。` : init.initialized ? "系统已初始化。重新初始化会重新拉取数据并重建画像，现有事件与收藏保留。" : "系统尚未初始化完成；正常流程请到「推荐」页点击开始初始化。"
						}),
						(0, react_jsx_runtime.jsx)(CheckField, {
						...
						(0, react_jsx_runtime.jsx)(Field, {
							label: "初始化 LLM 并发",
							hint: "默认 3；限流严重时可降到 1-2。",
							children: (0, react_jsx_runtime.jsx)(NumInput, {
								value: reinitLlmConcurrency,
								onChange: (v) => setReinitLlmConcurrency(Math.max(1, v)),
								min: 1
							})
						}),
						(0, react_jsx_runtime.jsx)(Field, {
							label: "初始化总超时（分钟）",
							hint: "默认 60；网络或模型很慢时可调大。",
							children: (0, react_jsx_runtime.jsx)(NumInput, {
								value: reinitInitTimeoutMinutes,
								onChange: (v) => setReinitInitTimeoutMinutes(Math.max(1, Math.min(1440, v))),
								min: 1,
								max: 1440
							})
						}),
		...
		function formatDiagAlertTime(epochSeconds) {
			const ts = Number(epochSeconds || 0) * 1e3;
		...
		function LoggingTab(props) {
			...
			const [diagBusy, setDiagBusy] = (0, react.useState)(false);
			const refreshDiag = (0, react.useCallback)(async () => {
				setDiagBusy(true);
				try {
			...
			const summaryText = !diag.loaded ? "读取异常报警中…" : diag.alerts.length > 0 ? `${diag.alerts.length} 条记录 · ${diag.errors} 错误 / ${diag.warnings} 警告` : "暂无异常报警";
			const metaLabel = (alert) => [
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)(Section, {
				...
				title: "异常报警",
				children: [(0, react_jsx_runtime.jsxs)("div", {
					className: panel_module_css_default.diagAlertHead,
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: panel_module_css_default.diagAlertSummary,
						"aria-live": "polite",
				...
				}), diag.alerts.length === 0 ? (0, react_jsx_runtime.jsx)("p", {
					className: panel_module_css_default.settingsHint,
					children: "暂无异常报警，LLM / Embedding 请求异常会显示在这里。"
				}) : (0, react_jsx_runtime.jsx)("ul", {
					className: panel_module_css_default.diagAlertList,
					children: diag.alerts.map((alert, index) => {
						...
						return (0, react_jsx_runtime.jsxs)("li", {
							className: panel_module_css_default.diagAlertItem,
							"data-severity": severity,
							children: [
								(0, react_jsx_runtime.jsxs)("div", {
									className: panel_module_css_default.diagAlertItemTop,
									children: [(0, react_jsx_runtime.jsx)("span", {
										className: panel_module_css_default.diagAlertBadge,
										children: severity === "error" ? "错误" : "警告"
									}), (0, react_jsx_runtime.jsx)("span", {
										className: panel_module_css_default.diagAlertSource,
										children: source !== "" ? `${categoryLabel} · ${source}` : categoryLabel
									})]
								}),
								(0, react_jsx_runtime.jsx)("div", {
									className: panel_module_css_default.diagAlertMessage,
									children: alert.message
								}),
								metaLabel(alert) !== "" ? (0, react_jsx_runtime.jsx)("div", {
									className: panel_module_css_default.diagAlertMeta,
									children: metaLabel(alert)
								}) : null
							]
						}, `${alert.code}-${alert.source}-${alert.last_seen}-${index}`);
					})
				})]
			})] });
		}
