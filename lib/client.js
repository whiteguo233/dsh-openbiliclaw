window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/white/workspace/OpenBiliClaw/.worktrees/dsh-plugin-issue3/src/client/panel.module.css.mjs
		const css = ".HDlONW_panel{--obc-bg:#fffafc;--obc-sky:#f2f8ff;--obc-surface:#ffffffd6;--obc-surface-strong:#fffffff7;--obc-surface-soft:#ffffffb8;--obc-line:#d9e3f2f2;--obc-line-strong:#f7adca80;--obc-text:#20304a;--obc-text-secondary:#60708c;--obc-text-muted:#8290a8;--obc-brand:#fb7299;--obc-brand-strong:#f65788;--obc-brand-soft:#fb72991f;--obc-sky-blue:#5aa9ff;--obc-sky-soft:#5aa9ff24;--obc-success:#30b980;--obc-danger:#ef7a86;--obc-shadow-lg:0 20px 40px #384c701f;--obc-shadow-sm:0 10px 22px #495d8214;min-width:0;height:100%;color:var(--obc-text);background:radial-gradient(circle at 15% 8%, #fb729929, transparent 30%), radial-gradient(circle at 88% 12%, #5aa9ff2e, transparent 26%), linear-gradient(180deg, var(--obc-bg) 0%, var(--obc-sky) 100%);background-attachment:fixed;flex-direction:column;font-family:Avenir Next,PingFang SC,Hiragino Sans GB,Microsoft YaHei,sans-serif;display:flex;position:relative;overflow:hidden}.HDlONW_panel button,.HDlONW_panel input,.HDlONW_panel textarea{font-family:inherit}.HDlONW_header{flex:none;align-items:center;gap:6px;padding:14px 14px 10px;display:flex}.HDlONW_brand{flex:1;align-items:center;gap:9px;min-width:0;display:flex}.HDlONW_brandMark{object-fit:cover;background:linear-gradient(135deg, var(--obc-brand), #ff8cb0);border-radius:10px;flex:none;width:30px;height:30px;display:block;box-shadow:0 8px 16px #fb729940}.HDlONW_brandCopy{flex-direction:column;min-width:0;display:flex}.HDlONW_brandTitle{color:var(--obc-text);letter-spacing:-.02em;white-space:nowrap;text-overflow:ellipsis;font-size:14px;font-weight:800;overflow:hidden}.HDlONW_status{align-items:center;gap:4px;display:flex}.HDlONW_statusDot{background:var(--obc-danger);border-radius:50%;width:6px;height:6px}.HDlONW_statusDot[data-online=true]{background:var(--obc-success)}.HDlONW_statusText{color:var(--obc-text-muted);font-size:10px}.HDlONW_iconButton{width:30px;height:30px;color:var(--obc-text-secondary);cursor:pointer;background:#ffffffc2;border:1px solid #e6edf8eb;border-radius:10px;flex:none;justify-content:center;align-items:center;transition:background .15s,transform .15s;display:flex;position:relative}.HDlONW_starButton{height:30px;color:var(--obc-brand-strong);cursor:pointer;background:linear-gradient(#fffcfef5,#fb72991a);border:1px solid #fb729947;border-radius:10px;flex:none;align-items:center;gap:5px;padding:0 9px;transition:transform .15s,border-color .15s,box-shadow .15s;display:inline-flex}.HDlONW_starButton:hover{border-color:#fb72998c;transform:translateY(-1px);box-shadow:0 6px 14px #fb72992e}.HDlONW_starCount{color:var(--obc-text-secondary);font-size:10.5px;font-weight:800;line-height:1}.HDlONW_starLabel{color:var(--obc-brand-strong);font-size:10.5px;font-weight:800;line-height:1}.HDlONW_iconButton:hover{background:var(--obc-brand-soft);color:var(--obc-brand-strong);transform:translateY(-1px)}.HDlONW_bellBadge{background:var(--obc-brand);color:#fff;min-width:16px;height:16px;box-shadow:0 0 0 2px var(--obc-bg);border-radius:8px;justify-content:center;align-items:center;padding:0 4px;font-size:9px;font-weight:700;display:flex;position:absolute;top:-5px;right:-5px}.HDlONW_settings{border-bottom:1px solid var(--obc-line);flex-direction:column;gap:6px;padding:0 14px 10px;display:flex}.HDlONW_settingsRow{align-items:center;gap:6px;display:flex}.HDlONW_settingsInput{min-width:0;color:var(--obc-text);background:#ffffffd9;border:1px solid #e6edf8eb;border-radius:8px;flex:1;padding:6px 9px;font-size:11px}.HDlONW_hint{color:var(--obc-text-muted);font-size:10.5px;line-height:1.5}.HDlONW_tabBar{flex:none;gap:6px;padding:0 14px 12px;display:flex}.HDlONW_tab{min-width:0;min-height:48px;color:var(--obc-text-secondary);cursor:pointer;background:0 0;border:0;border-radius:16px;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:3px;padding:7px 4px;font-size:10px;font-weight:700;line-height:1.3;transition:background .18s,color .18s,box-shadow .18s,transform .18s;display:flex}.HDlONW_tab:hover{color:var(--obc-text);background:#ffffff85}.HDlONW_tab[data-active=true]{color:var(--obc-brand-strong);background:linear-gradient(#fffffffa,#fff0f6fa);transform:translateY(-1px);box-shadow:0 10px 18px #fb729924}.HDlONW_badge{background:var(--obc-brand);color:#fff;text-align:center;vertical-align:1px;border-radius:8px;min-width:15px;height:15px;margin-left:3px;padding:0 4px;font-size:9px;font-weight:700;line-height:15px;display:inline-block}.HDlONW_body{flex-direction:column;flex:1;gap:12px;min-height:0;padding:2px 14px 20px;display:flex;overflow-y:auto}.HDlONW_body>*{flex-shrink:0}.HDlONW_empty{color:var(--obc-text-muted);text-align:center;padding:26px 10px;font-size:12px;line-height:1.7}.HDlONW_error{color:var(--obc-danger);white-space:pre-wrap;background:#ef7a861a;border:1px solid #ef7a8640;border-radius:10px;padding:8px 10px;font-size:11.5px;line-height:1.5}.HDlONW_toolbar{flex:none;align-items:center;gap:6px;display:flex}.HDlONW_spacer{flex:1}.HDlONW_sectionTitle{color:var(--obc-text);margin:4px 0 2px;font-size:12px;font-weight:800}.HDlONW_recHeader{box-shadow:var(--obc-shadow-sm);background:linear-gradient(#ffffffe6,#fafbffe6);border:1px solid #e6edf8eb;border-radius:18px;align-items:flex-start;gap:8px;padding:14px;display:flex}.HDlONW_recHeaderCopy{flex:1;min-width:0}.HDlONW_recKicker{letter-spacing:.08em;text-transform:uppercase;color:var(--obc-brand);font-size:9px;font-weight:700}.HDlONW_recHeaderTitle{color:var(--obc-text);letter-spacing:-.02em;margin-top:2px;font-size:16px;font-weight:800;line-height:1.35}.HDlONW_poolChips{flex-direction:column;gap:4px;margin-top:8px;display:flex}.HDlONW_poolChip{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:6px;justify-content:space-between;gap:8px;padding:3px 7px;font-size:10px;line-height:1.5;display:flex}.HDlONW_poolChipLabel{color:var(--obc-text-muted);flex:none;font-weight:600}.HDlONW_poolChipValue{text-align:right;word-break:break-word}.HDlONW_delightCard{background:linear-gradient(#fffcfefa,#fcf8fffa);border:1px solid #fb729947;border-radius:18px;flex-direction:column;gap:6px;padding:12px;display:flex;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.HDlONW_delightKickerLine{align-items:center;gap:6px;display:flex}.HDlONW_delightKicker{color:var(--obc-brand-strong);font-size:12px;font-weight:800}.HDlONW_delightCounter{color:var(--obc-text-muted);margin-left:auto;font-size:10px}.HDlONW_delightTitle{color:var(--obc-text);letter-spacing:-.01em;-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:14px;font-weight:800;line-height:1.4;display:-webkit-box;overflow:hidden}.HDlONW_card{box-shadow:var(--obc-shadow-sm);background:linear-gradient(#ffffffeb,#fafbffeb);border:1px solid #e6edf8eb;border-radius:16px;align-items:flex-start;gap:10px;padding:10px;transition:border-color .18s,box-shadow .18s;display:flex}.HDlONW_card:hover{border-color:var(--obc-line-strong);box-shadow:0 14px 26px #fb72991a}.HDlONW_thumb{object-fit:cover;background:linear-gradient(145deg,#fb72991f,#5aa9ff1a);border-radius:10px;flex:none;width:84px;height:58px;display:block}.HDlONW_thumbFallback{width:84px;height:58px;color:var(--obc-text-secondary);background:linear-gradient(145deg,#fb72991f,#5aa9ff1a);border-radius:10px;flex:none;justify-content:center;align-items:center;font-size:16px;font-weight:700;display:flex}.HDlONW_coverWrap{flex:none;position:relative}.HDlONW_coverCorner{color:#fff;background:#20304a9e;border-radius:4px;padding:0 4px;font-size:8px;font-weight:700;line-height:13px;position:absolute;top:4px;left:4px}.HDlONW_cardBody{flex-direction:column;flex:1;align-self:center;gap:3px;min-width:0;display:flex}.HDlONW_cardTitle{min-height:36px;color:var(--obc-text);letter-spacing:-.01em;-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:13px;font-weight:800;line-height:1.4;display:-webkit-box;overflow:hidden}.HDlONW_cardMeta{color:var(--obc-text-muted);flex-wrap:wrap;align-items:center;gap:6px;font-size:10px;display:flex}.HDlONW_platformTag{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:4px;padding:0 5px;font-size:9px;font-weight:600;line-height:15px}.HDlONW_badgeRow{flex-wrap:wrap;align-items:center;gap:5px;display:flex}.HDlONW_stateBadge{color:var(--obc-text-muted);background:#f0f6ffe6;border-radius:5px;padding:0 5px;font-size:9px;line-height:15px}.HDlONW_topicBadge{background:var(--obc-brand-soft);color:var(--obc-brand-strong);border-radius:5px;padding:0 5px;font-size:9px;font-weight:700;line-height:15px}.HDlONW_contextBadge{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:4px;padding:0 5px;font-size:9px;font-weight:600;line-height:15px}.HDlONW_contextBadge[data-kind=restored]{color:var(--obc-success);background:#30b9801f}.HDlONW_contextBadge[data-kind=removed]{color:var(--obc-danger);background:#ef7a861f}.HDlONW_stats{color:var(--obc-text-muted);flex-wrap:wrap;gap:8px;font-size:10px;display:flex}.HDlONW_expression{color:var(--obc-text-secondary);-webkit-line-clamp:3;-webkit-box-orient:vertical;font-size:11.5px;line-height:1.6;display:-webkit-box;overflow:hidden}.HDlONW_feedbackStatus{color:var(--obc-text-muted);min-height:13px;font-size:10.5px;line-height:1.4}.HDlONW_cardActions{flex-wrap:wrap;gap:6px;margin-top:3px;display:flex}.HDlONW_actionButton{cursor:pointer;min-height:26px;color:var(--obc-text-secondary);background:#f0f6ffe6;border:0;border-radius:11px;padding:4px 10px;font-size:11px;font-weight:600;line-height:1.2;transition:background .18s,color .18s,box-shadow .18s,transform .18s}.HDlONW_actionButton:hover:not(:disabled){color:var(--obc-text);transform:translateY(-1px)}.HDlONW_actionButton:disabled{cursor:not-allowed;opacity:.6;transform:none}.HDlONW_actionButton[data-primary=true]{background:linear-gradient(135deg, var(--obc-brand), #ff8cb0);color:#fff;font-weight:800;box-shadow:0 8px 14px #fb729938}.HDlONW_actionButton[data-primary=true]:hover:not(:disabled){background:linear-gradient(135deg, var(--obc-brand-strong), #ff7ca7);color:#fff}.HDlONW_actionButton[data-danger=true]:hover:not(:disabled){color:var(--obc-danger);background:#ef7a861f}.HDlONW_commentRow{align-items:center;gap:6px;display:flex}.HDlONW_commentInput{min-width:0;color:var(--obc-text);background:#ffffffd9;border:1px solid #e6edf8eb;border-radius:8px;flex:1;padding:4px 8px;font-size:11px}.HDlONW_commentInput:focus{border-color:var(--obc-sky-blue);outline:none}.HDlONW_loadMore{color:var(--obc-text-secondary);cursor:pointer;background:0 0;border:1px dashed #d9e3f2f2;border-radius:10px;padding:7px;font-size:11.5px}.HDlONW_loadMore:hover:not(:disabled){color:var(--obc-text);border-color:var(--obc-sky-blue)}.HDlONW_loadMore:disabled{opacity:.5}.HDlONW_loadingRow{color:var(--obc-text-muted);justify-content:center;align-items:center;gap:8px;padding:10px 0 4px;font-size:11px;font-weight:700;display:flex}.HDlONW_spinner{border:2px solid #fb729938;border-top-color:var(--obc-brand);border-radius:999px;width:14px;height:14px;animation:.8s linear infinite HDlONW_obcSpin}@keyframes HDlONW_obcSpin{to{transform:rotate(360deg)}}.HDlONW_activityFooter{border-top:1px solid var(--obc-line);padding-top:8px}.HDlONW_activityRow{color:var(--obc-text-secondary);gap:8px;padding:4px 0;font-size:11px;line-height:1.5;display:flex}.HDlONW_activityTime{color:var(--obc-text-muted);flex:none;padding-top:1px;font-size:10px}.HDlONW_subTabs{border:1px solid var(--obc-line);background:#ffffffa8;border-radius:12px;flex:none;gap:4px;padding:4px;display:flex}.HDlONW_subTab{color:var(--obc-text-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:0;border-radius:9px;flex:1;padding:6px 4px;font-size:10.5px;font-weight:700;line-height:1.4}.HDlONW_subTab:hover{color:var(--obc-text)}.HDlONW_subTab[data-active=true]{background:var(--obc-surface-strong);color:var(--obc-brand-strong);box-shadow:var(--obc-shadow-sm)}.HDlONW_syncToolbar{flex-direction:column;align-items:flex-start;gap:5px;margin-bottom:10px;display:flex}.HDlONW_syncMessage{color:var(--obc-text-muted);min-height:13px;font-size:10.5px;line-height:1.45}.HDlONW_syncMessage[data-tone=error]{color:var(--obc-danger)}.HDlONW_syncResults{border:1px solid var(--obc-line);background:#fff9;border-radius:12px;flex-direction:column;gap:5px;max-height:140px;margin-bottom:10px;padding:7px 8px;display:flex;overflow-y:auto}.HDlONW_syncLine{min-width:0;color:var(--obc-text-secondary);align-items:center;gap:6px;font-size:10.5px;line-height:1.45;display:flex}.HDlONW_syncLineText{text-overflow:ellipsis;white-space:nowrap;color:var(--obc-text);flex:0 auto;font-weight:700;overflow:hidden}.HDlONW_syncLineDetail{text-overflow:ellipsis;white-space:nowrap;color:var(--obc-text-muted);flex:1;overflow:hidden}.HDlONW_syncBadgeRow{align-items:center;gap:6px;min-width:0;display:flex}.HDlONW_syncInlineDetail{text-overflow:ellipsis;white-space:nowrap;color:var(--obc-text-muted);font-size:10px;overflow:hidden}.HDlONW_syncChip{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:999px;flex:none;padding:2px 7px;font-size:9.5px;font-weight:700;line-height:15px}.HDlONW_syncChip[data-tone=success]{color:var(--obc-success);background:#30b9801f}.HDlONW_syncChip[data-tone=warning]{color:#8a6520;background:#ffc10724}.HDlONW_syncChip[data-tone=error]{color:var(--obc-danger);background:#ef7a861f}.HDlONW_syncChip[data-tone=info]{color:var(--obc-brand-strong);background:var(--obc-brand-soft)}.HDlONW_turn{flex-direction:column;gap:3px;display:flex}.HDlONW_turnUser,.HDlONW_turnSoul{white-space:pre-wrap;word-break:break-word;border-radius:14px;padding:8px 11px;font-size:12px;line-height:1.6}.HDlONW_turnUser{background:var(--obc-brand-soft);color:var(--obc-text);align-self:flex-end;max-width:92%}.HDlONW_turnSoul{border:1px solid var(--obc-line);color:var(--obc-text);background:#ffffffe6;align-self:flex-start;max-width:92%}.HDlONW_turnStatus{color:var(--obc-text-muted);align-self:flex-end;font-size:10px}.HDlONW_chatInputRow{border-top:1px solid var(--obc-line);flex:none;gap:6px;padding-top:8px;display:flex}.HDlONW_chatInput{min-width:0;color:var(--obc-text);resize:none;background:#ffffffe6;border:1px solid #e6edf8eb;border-radius:12px;flex:1;padding:8px 10px;font-size:12px}.HDlONW_chatInput:focus{border-color:var(--obc-sky-blue);outline:none}.HDlONW_chatSend{background:linear-gradient(135deg, var(--obc-brand), #ff8cb0);color:#fff;cursor:pointer;border:0;border-radius:12px;padding:0 14px;font-size:12px;font-weight:800;box-shadow:0 8px 14px #fb729938}.HDlONW_chatSend:hover:not(:disabled){background:linear-gradient(135deg, var(--obc-brand-strong), #ff7ca7)}.HDlONW_chatSend:disabled{opacity:.6}.HDlONW_confirmPanel{border:1px solid var(--obc-line);background:#ffffffd9;border-radius:14px;flex:none;overflow:hidden}.HDlONW_confirmToggle{width:100%;color:var(--obc-text);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:6px;padding:9px 11px;font-size:12px;font-weight:800;display:flex}.HDlONW_confirmToggle:hover{background:var(--obc-brand-soft)}.HDlONW_confirmCount{color:#fff;background:var(--obc-brand);border-radius:8px;margin-left:auto;padding:1px 7px;font-size:10px;font-weight:700}.HDlONW_confirmItem{border-top:1px solid var(--obc-line);flex-direction:column;gap:4px;padding:10px 11px;display:flex}.HDlONW_confirmTitle{color:var(--obc-text);font-size:12px;font-weight:800;line-height:1.5}.HDlONW_cardTurn{border:1px solid var(--obc-line);background:#ffffffe6;border-radius:14px;flex-direction:column;gap:4px;padding:10px 11px;display:flex}.HDlONW_insightEvidence{color:var(--obc-text-secondary);white-space:pre-wrap;font-size:11px;line-height:1.55}.HDlONW_insightNote{color:var(--obc-text-muted);font-size:10.5px}.HDlONW_probeConfidence{color:var(--obc-text-muted);font-size:10px}.HDlONW_portrait{color:var(--obc-text);border:1px solid var(--obc-line);background:#ffffffd9;border-radius:14px;padding:11px 12px;font-size:12.5px;line-height:1.7}.HDlONW_chipRow{flex-wrap:wrap;gap:5px;display:flex}.HDlONW_chip{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:11px;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:1.6}.HDlONW_chip[data-kind=dislike]{color:var(--obc-danger);background:#ef7a861f}.HDlONW_interestDomain{margin-bottom:6px}.HDlONW_interestDomainHead{color:var(--obc-text);align-items:center;gap:6px;font-size:12px;font-weight:800;display:flex}.HDlONW_domainWeight{color:var(--obc-text-muted);font-size:10px;font-weight:600}.HDlONW_awarenessRow{color:var(--obc-text-secondary);padding:4px 0;font-size:11px;line-height:1.55}.HDlONW_awarenessDate{color:var(--obc-text-muted);margin-right:6px}.HDlONW_probe{border:1px solid var(--obc-line);background:#ffffffd9;border-radius:12px;flex-direction:column;gap:4px;padding:10px 11px;display:flex}.HDlONW_probeDomain{color:var(--obc-text);font-size:12px;font-weight:800}.HDlONW_probeReason{color:var(--obc-text-secondary);font-size:11.5px;line-height:1.55}.HDlONW_probeActions{flex-wrap:wrap;gap:6px;margin-top:2px;display:flex}.HDlONW_drawerOverlay{z-index:10;backdrop-filter:blur(2px);background:#20304a47;flex-direction:column;justify-content:flex-start;display:flex;position:absolute;inset:0}.HDlONW_drawerPanel{background:radial-gradient(circle at 15% 4%, #fb729924, transparent 30%), var(--obc-bg);border-radius:18px 18px 0 0;flex-direction:column;flex:1;gap:10px;min-height:0;margin-top:8px;padding:14px 14px 24px;display:flex;overflow-y:auto}.HDlONW_drawerHeader{border-bottom:1px solid var(--obc-line);justify-content:space-between;align-items:center;padding-bottom:10px;display:flex}.HDlONW_drawerTitle{color:var(--obc-text);align-items:center;gap:6px;font-size:15px;font-weight:800;display:flex}.HDlONW_messageCard{background:var(--obc-surface-strong);border:1px solid var(--obc-line);border-radius:14px;flex-direction:column;gap:5px;padding:11px 12px;display:flex}.HDlONW_messageCard[data-tone=interest]{background:linear-gradient(135deg,#fff8e8,#fff0d5);border-color:#dd7f2d47}.HDlONW_messageCard[data-tone=avoidance]{background:linear-gradient(135deg,#eef7ff,#e1effc);border-color:#3b82f647}.HDlONW_messageCard[data-tone=challenge]{background:linear-gradient(135deg,#f7f2ff,#ede9fe);border-color:#7c3aed47}.HDlONW_messageCard[data-tone=delight]{background:linear-gradient(135deg,#fff5f8,#ffe9f0);border-color:#fb729952}.HDlONW_messageType{color:var(--obc-text-secondary);align-items:center;gap:5px;font-size:10.5px;font-weight:800;display:flex}.HDlONW_messageCard[data-tone=interest] .HDlONW_messageType{color:#c26a1d}.HDlONW_messageCard[data-tone=avoidance] .HDlONW_messageType{color:#2b6cc4}.HDlONW_messageCard[data-tone=challenge] .HDlONW_messageType{color:#7c3aed}.HDlONW_messageCard[data-tone=delight] .HDlONW_messageType{color:var(--obc-brand-strong)}.HDlONW_messagePrompt{color:var(--obc-text-secondary);font-size:10.5px;line-height:1.5}.HDlONW_messageTitle{color:var(--obc-text);font-size:13px;font-weight:800;line-height:1.45}.HDlONW_messageBody{color:#55657f;-webkit-line-clamp:4;-webkit-box-orient:vertical;font-size:11px;line-height:1.55;display:-webkit-box;overflow:hidden}.HDlONW_messageActions{flex-wrap:wrap;gap:6px;margin-top:2px;display:flex}.HDlONW_drawerEmpty{color:var(--obc-text-muted);flex-direction:column;align-items:center;gap:8px;padding:34px 20px;display:flex}.HDlONW_drawerEmptyTitle{font-size:13px;font-weight:700}.HDlONW_drawerEmptySubtitle{opacity:.75;font-size:11px}.HDlONW_recCard{background:linear-gradient(#fffffffa,#fafbfffa);border:1px solid #ebf0f8fa;border-radius:18px;flex-direction:column;gap:9px;padding:10px;transition:border-color .18s,box-shadow .18s;display:flex;box-shadow:inset 0 1px #ffffffd1}.HDlONW_recCard:hover{border-color:var(--obc-line-strong);box-shadow:0 18px 32px #fb729924}.HDlONW_recCover{aspect-ratio:16/9;cursor:pointer;width:100%;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb72991f,#5aa9ff1a),#f6f9fff0;border:0;border-radius:13px;justify-content:center;align-items:center;padding:0;font-size:12px;font-weight:700;line-height:1.5;display:flex;position:relative;overflow:hidden}.HDlONW_recCover img{object-fit:cover;width:100%;height:100%;display:block}.HDlONW_recCoverText{color:var(--obc-text);-webkit-line-clamp:4;-webkit-box-orient:vertical;padding:12px;font-size:12px;line-height:1.6;display:-webkit-box;overflow:hidden}.HDlONW_recCover .HDlONW_coverCorner{top:8px;left:8px}.HDlONW_recBody{flex-direction:column;gap:4px;padding:0 2px;display:flex}.HDlONW_recTitle{color:var(--obc-text);letter-spacing:-.01em;-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:15px;font-weight:800;line-height:1.38;display:-webkit-box;overflow:hidden}.HDlONW_delightRow{align-items:stretch;gap:10px;display:flex}.HDlONW_delightThumb{object-fit:cover;border-radius:12px;flex:none;align-self:center;width:96px;height:96px;box-shadow:inset 0 1px #ffffffb8}.HDlONW_delightThumbFallback{box-sizing:border-box;width:96px;height:96px;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb729924,#5aa9ff1f);border-radius:12px;flex:none;justify-content:center;align-self:center;align-items:center;padding:8px;font-size:10.5px;font-weight:700;line-height:1.5;display:flex;overflow:hidden}.HDlONW_delightCard{background:radial-gradient(circle at 100% 0,#fb729924,#0000 38%),linear-gradient(#fffcfefa,#f6fafffa);border:1px solid #fb729947;border-radius:18px;flex-shrink:0;grid-template-columns:minmax(0,1fr) 40px;gap:0;padding:0;transition:border-color .2s,box-shadow .2s;display:grid;overflow:hidden;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.HDlONW_delightRow{cursor:pointer;text-align:left;min-width:0;color:inherit;background:0 0;border:0;grid-area:1/1;align-items:center;gap:10px;padding:10px;display:flex}.HDlONW_delightThumb{aspect-ratio:16/9;object-fit:cover;background:linear-gradient(#fffffffa,#fff8fcf0),linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:12px;flex:none;width:104px;height:auto;transition:transform .2s,box-shadow .2s;box-shadow:inset 0 1px #ffffffb8,0 2px 8px #fb72991f}.HDlONW_delightCard:hover .HDlONW_delightThumb{transform:scale(1.02);box-shadow:inset 0 1px #ffffffb8,0 6px 14px #fb729938}.HDlONW_delightText{flex-direction:column;flex:1;gap:6px;min-width:0;display:flex}.HDlONW_delightKickerLine{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.HDlONW_delightKicker{color:var(--obc-brand-strong);letter-spacing:.02em;text-overflow:ellipsis;white-space:nowrap;background:#fb72991a;border-radius:999px;max-width:100%;padding:2px 7px;font-size:9.5px;font-weight:700;overflow:hidden}.HDlONW_delightCounter{color:var(--obc-text-muted);white-space:nowrap;background:#0000000a;border-radius:8px;flex:none;padding:1px 6px;font-size:10px;font-weight:600}.HDlONW_delightNav:active:not(:disabled){transform:scale(.94)}.HDlONW_delightDismiss{color:var(--obc-text-muted);cursor:pointer;background:0 0;border:0;border-left:1px solid #eddbe999;grid-area:1/2;font-size:15px;line-height:1;transition:background .15s,color .15s}.HDlONW_delightBody{border-top:1px solid #eddbe999;flex-direction:column;grid-area:2/1/auto/-1;gap:8px;padding:4px 12px 12px;display:flex}.HDlONW_activityFooter{border:1px solid var(--obc-line);backdrop-filter:blur(18px);box-shadow:var(--obc-shadow-sm);background:#ffffffa8;border-radius:14px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.HDlONW_activityLine{color:var(--obc-text-secondary);font-size:11.5px;line-height:1.5}.HDlONW_footerItem{background:#fffc;border:1px solid #dfe7f3f5;border-radius:12px;flex-direction:column;gap:3px;padding:8px 10px;display:flex}.HDlONW_footerItemMeta{color:var(--obc-text-muted);flex-wrap:wrap;align-items:center;gap:7px;font-size:9.5px;font-weight:700;line-height:1.4;display:flex}.HDlONW_footerItemKind{min-height:18px;color:var(--obc-text-secondary);background:#fffffff5;border:1px solid #dfe7f3f5;border-radius:999px;align-items:center;padding:2px 7px;display:inline-flex}.HDlONW_footerItemSummary{color:var(--obc-text-secondary);word-break:break-word;font-size:11px;line-height:1.55}.HDlONW_pinnedFooter{border-top:1px solid var(--obc-line);backdrop-filter:blur(18px);background:#ffffff80;flex:none;padding:9px 14px 12px}.HDlONW_pinnedFooter .HDlONW_activityFooter{box-shadow:none;backdrop-filter:none;background:0 0;border:0;border-radius:0;gap:5px;margin:0;padding:6px 2px 2px}.HDlONW_expression{-webkit-line-clamp:unset;display:block;overflow:visible}.HDlONW_savedToggle{min-width:38px;min-height:26px;color:var(--obc-text-secondary);cursor:pointer;background:#f0f6ffe6;border:0;border-radius:11px;justify-content:center;align-items:center;transition:background .15s,color .15s,transform .15s;display:inline-flex}.HDlONW_savedToggle:hover:not(:disabled){color:var(--obc-text);transform:translateY(-1px)}.HDlONW_savedToggle:disabled{opacity:.6;cursor:wait}.HDlONW_savedToggle[data-pressed=true].HDlONW_watchToggle{color:var(--obc-brand-strong);background:var(--obc-brand-soft)}.HDlONW_savedToggle[data-pressed=true].HDlONW_starToggle{color:#e8a33d;background:#e8a33d1f}.HDlONW_savedToggle[data-pressed=true].HDlONW_starToggle svg{fill:currentColor}.HDlONW_feedbackStatus{color:var(--obc-brand-strong);min-height:15px;margin-top:2px;font-size:11px;line-height:1.5}.HDlONW_feedbackStatus[data-tone=success]{color:var(--obc-success)}.HDlONW_feedbackStatus[data-tone=error]{color:var(--obc-danger)}.HDlONW_commentComposer{flex-direction:column;gap:6px;margin-top:2px;display:flex}.HDlONW_commentComposer textarea{box-sizing:border-box;width:100%;color:var(--obc-text);resize:vertical;background:#ffffffe6;border:1px solid #e6edf8eb;border-radius:10px;padding:8px 9px;font-family:inherit;font-size:11.5px}.HDlONW_commentComposer textarea:focus{border-color:var(--obc-sky-blue);outline:none}.HDlONW_commentComposer .HDlONW_actionButton{align-self:flex-end}.HDlONW_activityFooter{background:linear-gradient(#fffffffa,#f2f6fdf5);border:1px solid #dfe7f3fa;border-radius:18px;flex-direction:column;gap:10px;margin:0;padding:12px 14px;display:flex;box-shadow:0 12px 24px #495d8214}.HDlONW_footerHead{justify-content:space-between;align-items:flex-start;gap:10px;display:flex}.HDlONW_footerCopy{flex-direction:column;flex:auto;gap:6px;min-width:0;display:flex}.HDlONW_footerHint{color:#41506b;min-height:18px;margin:0;padding-left:20px;font-size:12px;font-weight:700;line-height:1.6;position:relative}.HDlONW_footerHint:before{content:\"\";background:var(--obc-sky-blue);border-radius:999px;width:9px;height:9px;position:absolute;top:50%;left:0;transform:translateY(-50%);box-shadow:0 0 0 4px #5aa9ff1f}.HDlONW_footerHeadline{min-height:16px;color:var(--obc-text-muted);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;padding-left:20px;font-size:10.5px;font-weight:700;line-height:1.55;display:-webkit-box;position:relative;overflow:hidden}.HDlONW_footerHeadline:before{content:\"\";background:#fb72994d;border-radius:999px;width:9px;height:9px;position:absolute;top:50%;left:0;transform:translateY(-50%);box-shadow:0 0 0 4px #fb729914}.HDlONW_footerToggle{min-height:32px;color:var(--obc-text-secondary);cursor:pointer;background:#ffffffdb;border:0;border-radius:999px;flex-shrink:0;padding:7px 12px;font-size:11px;font-weight:800;line-height:1;box-shadow:0 8px 18px #495d8214}.HDlONW_footerToggle:hover{color:var(--obc-text)}.HDlONW_footerHistory{flex-direction:column;gap:8px;max-height:190px;display:flex;overflow-y:auto}.HDlONW_pendingItem{border-top:1px solid var(--obc-line);grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:10px;display:grid}.HDlONW_pendingCopy{gap:2px;min-width:0;display:grid}.HDlONW_pendingCopy strong{overflow-wrap:anywhere;color:var(--obc-text);font-size:12px;font-weight:800;line-height:1.45}.HDlONW_pendingKind,.HDlONW_pendingConfidence{color:var(--obc-text-secondary);font-size:10.5px;font-weight:700}.HDlONW_pendingOpen{cursor:pointer;border:1px solid var(--obc-line-strong);background:var(--obc-brand-soft);min-width:52px;min-height:34px;color:var(--obc-brand-strong);border-radius:999px;padding:6px 12px;font-size:11px;font-weight:800}.HDlONW_pendingOpen:hover:not(:disabled){background:#fb729933}.HDlONW_pendingOpen:disabled{opacity:.6;cursor:wait}.HDlONW_dialogueCard{box-sizing:border-box;overflow-wrap:anywhere;border:1px solid var(--obc-line-strong);background:var(--obc-surface-strong);width:100%;box-shadow:var(--obc-shadow-sm);border-radius:14px;flex-direction:column;gap:5px;padding:12px;display:flex}.HDlONW_dialogueCard[data-card-state=confirmed]{border-color:#30b9808c}.HDlONW_dialogueCard[data-card-state=rejected]{border-color:#ef7a8694}.HDlONW_dialogueCard[data-card-state=deferred]{border-color:#8f9bb09e}.HDlONW_dialogueKicker{color:var(--obc-brand-strong);letter-spacing:.06em;font-size:10.5px;font-weight:800}.HDlONW_dialogueTitle{color:var(--obc-text);font-size:13.5px;font-weight:700;line-height:1.55}.HDlONW_dialogueState{color:var(--obc-text-secondary);font-size:11.5px;font-weight:700}.HDlONW_dialogueEvidence{color:var(--obc-text-secondary);font-size:11.5px}.HDlONW_dialogueEvidence summary{cursor:pointer;width:fit-content;color:var(--obc-text-secondary);align-items:center;font-weight:700;display:flex}.HDlONW_dialogueEvidence ul{gap:5px;margin:3px 0 0 16px;line-height:1.55;display:grid}.HDlONW_dialogueActions{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin-top:6px;display:grid}.HDlONW_dialogueAction{cursor:pointer;border:1px solid var(--obc-line);background:var(--obc-surface);min-width:0;min-height:34px;color:var(--obc-text);border-radius:999px;padding:7px;font-size:12px;font-weight:800;transition:background .15s,transform .15s}.HDlONW_dialogueAction:hover:not(:disabled){transform:translateY(-1px)}.HDlONW_dialogueAction:disabled{cursor:default;opacity:.5}.HDlONW_dialogueAction.HDlONW_action_confirm{color:var(--obc-success)}.HDlONW_dialogueAction.HDlONW_action_reject{color:var(--obc-danger)}.HDlONW_dialogueAction.HDlONW_action_discuss{color:var(--obc-brand-strong)}.HDlONW_contextBar{border:1px solid var(--obc-line-strong);background:var(--obc-surface-soft);border-radius:12px;flex-direction:column;flex:none;gap:4px;min-width:0;padding:9px 11px;display:flex}.HDlONW_contextBarHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.HDlONW_contextLabel{letter-spacing:.04em;color:var(--obc-brand-strong);font-size:10px;font-weight:800}.HDlONW_contextTitle{color:var(--obc-text);overflow-wrap:anywhere;font-size:12.5px;font-weight:800;line-height:1.45}.HDlONW_contextObservation{color:var(--obc-text-secondary);-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:11px;line-height:1.55;display:-webkit-box;overflow:hidden}.HDlONW_contextInterpretation{color:#2b6cc4;font-size:10.5px;font-weight:600;line-height:1.5}.HDlONW_contextClear{color:var(--obc-text-secondary);cursor:pointer;background:#fffc;border:0;border-radius:999px;flex:none;padding:4px 10px;font-size:10.5px;font-weight:700}.HDlONW_contextClear:hover{color:var(--obc-text)}.HDlONW_replyQuote{border-left:3px solid var(--obc-brand);background:var(--obc-brand-soft);border-radius:8px;flex-direction:column;gap:1px;min-width:0;padding:6px 9px;display:flex}.HDlONW_replyQuote span{color:var(--obc-brand-strong);letter-spacing:.04em;font-size:9.5px;font-weight:800}.HDlONW_replyQuote strong{color:var(--obc-text-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:1.4;overflow:hidden}.HDlONW_viewIntro{padding:2px 4px 0}.HDlONW_viewKicker{letter-spacing:.08em;text-transform:uppercase;color:var(--obc-brand);font-size:9px;font-weight:700}.HDlONW_viewIntro h2{color:var(--obc-text);letter-spacing:-.02em;margin:2px 0 0;font-size:15px;font-weight:800;line-height:1.35}.HDlONW_viewIntro p{color:var(--obc-text-secondary);margin:3px 0 0;font-size:11px;line-height:1.6}.HDlONW_profileCard{flex-direction:column;gap:10px;display:flex}.HDlONW_profileSummary{background:#fcfafbf5;border:1px solid #e4dce8b3;border-radius:16px;padding:14px 16px}.HDlONW_profilePortraitP{color:var(--obc-text);text-indent:1.6em;margin:0;font-size:12.5px;line-height:1.85}.HDlONW_profilePortraitP:first-child{text-indent:0}.HDlONW_profileLayer{text-transform:uppercase;letter-spacing:.05em;color:var(--obc-text-muted);border-bottom:1px solid #e7eef899;margin-top:10px;margin-bottom:2px;padding:5px 0;font-size:9.5px;font-weight:700}.HDlONW_profileGroup{background:#fffffff0;border:1px solid #e7eef8f5;border-radius:16px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.HDlONW_profileGroup h3{color:var(--obc-text);margin:0;font-size:12px;font-weight:800;line-height:1.4}.HDlONW_profilePhaseCopy{color:var(--obc-text-secondary);margin:0;font-size:12px;line-height:1.7}.HDlONW_chip[data-tone=brand]{background:var(--obc-brand-soft);color:var(--obc-brand-strong)}.HDlONW_chip[data-tone=success]{color:var(--obc-success);background:#30b9801f}.HDlONW_chip[data-tone=danger]{color:var(--obc-danger);background:#ef7a861f}.HDlONW_chipWeight{opacity:.75;margin-left:3px;font-size:9px}.HDlONW_mbtiContainer{flex-direction:column;gap:8px;display:flex}.HDlONW_mbtiTypeRow{align-items:baseline;gap:8px;display:flex}.HDlONW_mbtiTypeLabel{color:var(--obc-brand-strong);letter-spacing:.02em;font-size:18px;font-weight:800}.HDlONW_mbtiConfidence{color:var(--obc-text-muted);background:#e7eef8f5;border-radius:999px;padding:2px 8px;font-size:9.5px;font-weight:600}.HDlONW_mbtiDimensions{flex-direction:column;gap:6px;display:flex}.HDlONW_mbtiDimRow{align-items:center;gap:8px;font-size:10.5px;display:flex}.HDlONW_mbtiDimPole{text-align:center;width:20px;color:var(--obc-brand-strong);font-weight:700}.HDlONW_mbtiDimBar{background:#e7eef8f5;border-radius:3px;flex:1;height:6px;overflow:hidden}.HDlONW_mbtiDimBarFill{background:linear-gradient(90deg,#f7828e,#c7698f);border-radius:3px;height:100%}.HDlONW_mbtiDimPct{text-align:right;width:32px;color:var(--obc-text-muted);font-size:9.5px}.HDlONW_interestTree{flex-direction:column;gap:8px;display:flex}.HDlONW_interestTreeLabel{font-size:11.5px;font-weight:700}.HDlONW_interestTreeLabel[data-tone=sky]{color:var(--obc-sky-blue)}.HDlONW_interestTreeLabel[data-tone=danger]{color:var(--obc-danger)}.HDlONW_interestDomain{flex-direction:column;gap:5px;display:flex}.HDlONW_interestDomainHeader{align-items:center;gap:6px;display:flex}.HDlONW_interestDomainName{color:var(--obc-text);font-size:12px;font-weight:800}.HDlONW_interestDomainWeight{color:var(--obc-text-muted);background:#e7eef8f5;border-radius:999px;padding:1px 7px;font-size:9.5px;font-weight:600}.HDlONW_barRow{align-items:center;gap:8px;font-size:11px;display:flex}.HDlONW_barLabel{min-width:64px;color:var(--obc-text-secondary)}.HDlONW_barTrack{background:#e7eef8f5;border-radius:3px;flex:1;height:6px;overflow:hidden}.HDlONW_barFill{background:linear-gradient(90deg,#397fcb,#5e9fd9);border-radius:3px;height:100%}.HDlONW_barPct{text-align:right;width:34px;color:var(--obc-text-muted);font-size:9.5px}.HDlONW_contextRow{gap:8px;font-size:11px;display:flex}.HDlONW_contextLabel{color:var(--obc-text-secondary);flex:none;min-width:44px}.HDlONW_contextValue{color:var(--obc-text)}.HDlONW_probe[data-tone=interest]{background:linear-gradient(135deg,#fff8e8,#fff0d5);border-color:#dd7f2d47}.HDlONW_probe[data-tone=avoidance]{background:linear-gradient(135deg,#eef7ff,#e1effc);border-color:#3b82f647}.HDlONW_probeHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.HDlONW_insightCard{border:1px solid var(--obc-line);background:#fffffff0;border-radius:14px;flex-direction:column;gap:7px;padding:12px 14px;display:flex}.HDlONW_insightCard[data-validated]{border-color:#30b98080}.HDlONW_insightHead{align-items:flex-start;gap:6px;display:flex}.HDlONW_insightTitle{color:var(--obc-text);flex:1;font-size:12px;font-weight:800;line-height:1.5}.HDlONW_insightValidated{color:var(--obc-success);background:#30b9801f;border-radius:999px;flex:none;padding:2px 7px;font-size:9.5px;font-weight:700}.HDlONW_insightConfidenceRow{align-items:center;gap:8px;display:flex}.HDlONW_insightConfidenceBar{background:#e7eef8f5;border-radius:3px;flex:1;height:6px;overflow:hidden}.HDlONW_insightConfidenceFill{background:linear-gradient(90deg,#f7828e,#c7698f);border-radius:3px;height:100%}.HDlONW_insightConfidenceLabel{color:var(--obc-text-muted);text-align:right;width:32px;font-size:9.5px}.HDlONW_insightEvidenceList{color:var(--obc-text-secondary);gap:4px;margin:0;padding-left:16px;font-size:11px;line-height:1.55;display:grid}.HDlONW_awarenessList{flex-direction:column;gap:8px;display:flex}.HDlONW_awarenessItem{background:#fffcf7f7;border:1px solid #f0e6d7e6;border-radius:14px;flex-direction:column;gap:4px;padding:10px 13px;display:flex}.HDlONW_awarenessHeader{align-items:center;gap:8px;display:flex}.HDlONW_awarenessItemDate{color:var(--obc-text-muted);white-space:nowrap;font-size:10px}.HDlONW_awarenessEmotion{color:var(--obc-brand);font-size:10px;font-weight:600}.HDlONW_awarenessObservation{color:var(--obc-text);font-size:11.5px;line-height:1.65}.HDlONW_awarenessTrend{color:var(--obc-text-secondary);border-left:2px solid #fb729940;padding-left:8px;font-size:11px;line-height:1.5}.HDlONW_questionCard{box-sizing:border-box;width:100%;box-shadow:var(--obc-shadow-sm);background:linear-gradient(135deg,#eef7ff,#e1effc);border:1px solid #3b82f647;border-radius:14px;flex-direction:column;gap:6px;padding:12px;display:flex}.HDlONW_pendingObservation{color:var(--obc-text-secondary);font-size:11px;line-height:1.55}.HDlONW_pendingInterpretation{color:var(--obc-sky-blue);font-size:10.5px;font-weight:600;line-height:1.5}.HDlONW_questionObservation{color:var(--obc-text);background:#ffffffb3;border-radius:8px;padding:6px 9px;font-size:11.5px;line-height:1.6}.HDlONW_questionInterpretation{color:#2b6cc4;font-size:11px;font-weight:600;line-height:1.55}.HDlONW_delightCard{background:radial-gradient(circle at 100% 0,#fb729924,#0000 38%),linear-gradient(#fffcfefa,#f6fafffa);border:1px solid #fb729938;border-radius:16px;flex-direction:column;grid-template-columns:none;gap:0;padding:0;transition:border-color .2s,box-shadow .2s;display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.HDlONW_delightKicker{color:var(--obc-brand-strong);letter-spacing:.02em;white-space:nowrap;background:#fb72991a;border-radius:999px;padding:2px 7px;font-size:9.5px;font-weight:700}.HDlONW_delightPlatform{color:var(--obc-text-muted);white-space:nowrap;background:#0000000d;border-radius:999px;flex:none;padding:2px 6px;font-size:9.5px;font-weight:600}.HDlONW_delightCounter{color:var(--obc-text-muted);white-space:nowrap;flex:none;font-size:10px;font-weight:600}.HDlONW_delightNav{width:26px;height:26px;color:var(--obc-brand-strong);cursor:pointer;background:#fffc;border:1px solid #fb729938;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;font-size:14px;font-weight:700;line-height:1;transition:background .15s,border-color .15s;display:inline-flex}.HDlONW_delightNav:hover:not(:disabled){background:#fb729924;border-color:#fb729973}.HDlONW_delightNav:disabled{opacity:.32;cursor:default}.HDlONW_delightDismiss{width:26px;height:26px;color:var(--obc-text-secondary);cursor:pointer;background:#0000000a;border:0;border-left-width:medium;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;font-size:15px;line-height:1;transition:background .15s,color .15s;display:inline-flex}.HDlONW_delightRow{cursor:pointer;text-align:left;min-width:0;color:inherit;background:0 0;border:0;align-items:center;gap:10px;padding:8px 10px 10px;display:flex}.HDlONW_delightThumb{aspect-ratio:auto;object-fit:cover;background:linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:10px;flex:none;width:104px;height:58px;box-shadow:inset 0 1px #ffffffb8,0 2px 8px #fb72991f}.HDlONW_delightThumbFallback{aspect-ratio:auto;box-sizing:border-box;width:104px;height:58px;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:10px;flex:none;justify-content:center;align-items:center;padding:4px;font-size:9px;font-weight:700;line-height:1.4;display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffffb8}.HDlONW_delightText{flex:1;align-items:center;min-width:0;display:flex}.HDlONW_delightTitle{min-width:0;color:var(--obc-text);-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;font-size:12.5px;font-weight:700;line-height:1.55;display:-webkit-box;overflow:hidden}.HDlONW_delightChevron{width:24px;height:24px;color:var(--obc-text-muted);cursor:pointer;background:#ffffffb3;border:0;border-radius:50%;flex:none;justify-content:center;align-items:center;font-size:10px;line-height:1;display:inline-flex}.HDlONW_delightCard{background:radial-gradient(circle at 100% 0,#fb729924,#0000 38%),linear-gradient(#fffcfefa,#f6fafffa);border:1px solid #fb729947;border-radius:18px;flex-direction:column;flex-shrink:0;gap:0;padding:0;transition:border-color .2s,box-shadow .2s;display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.HDlONW_delightCard:hover{border-color:#fb729980;box-shadow:inset 0 1px #ffffffd1,0 12px 28px #fb72992e}.HDlONW_delightHeader{align-items:center;gap:7px;min-width:0;padding:10px 12px 2px;display:flex}.HDlONW_delightMain{cursor:pointer;text-align:left;min-width:0;color:inherit;background:0 0;border:0;flex-direction:column;gap:8px;padding:4px 10px 10px;display:flex}.HDlONW_delightCover{aspect-ratio:16/9;background:linear-gradient(#fffffffa,#fff8fcf0),linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:14px;width:100%;transition:box-shadow .2s;display:block;position:relative;overflow:hidden;box-shadow:inset 0 1px #ffffffb8,0 2px 8px #fb72991f}.HDlONW_delightCard:hover .HDlONW_delightCover{box-shadow:inset 0 1px #ffffffb8,0 8px 18px #fb729938}.HDlONW_delightHero{object-fit:cover;width:100%;height:100%;transition:transform .35s;display:block}.HDlONW_delightCard:hover .HDlONW_delightHero{transform:scale(1.03)}.HDlONW_delightCover:before{content:\"✨\";width:27px;height:27px;color:var(--obc-brand-strong);text-align:center;pointer-events:none;z-index:2;background:#fffffff0;border-radius:999px;font-size:15px;line-height:27px;position:absolute;top:8px;left:8px;box-shadow:0 2px 8px #fb72994d}.HDlONW_delightCoverScrim{pointer-events:none;z-index:1;background:linear-gradient(#0000,#141a2870);height:40%;position:absolute;inset:auto 0 0}.HDlONW_delightScorePill{z-index:2;color:#fff;letter-spacing:.01em;background:linear-gradient(135deg,#fb7299f5,#e25885e6);border-radius:999px;padding:3px 10px;font-size:10.5px;font-weight:800;line-height:1.4;position:absolute;bottom:8px;left:8px;box-shadow:0 2px 8px #fb72995c}.HDlONW_delightHeroFallback{box-sizing:border-box;width:100%;height:100%;min-height:96px;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb729924,#5aa9ff1a);justify-content:center;align-items:center;padding:12px 14px;font-size:11px;font-weight:700;line-height:1.55;display:flex;overflow:hidden}.HDlONW_delightCover:has(.HDlONW_delightHeroFallback){aspect-ratio:auto}.HDlONW_delightTitleWrap{align-items:center;gap:8px;min-width:0;padding:0 2px;display:flex}.HDlONW_delightTitle{min-width:0;color:var(--obc-text);-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;flex:1;font-size:13px;font-weight:800;line-height:1.5;display:-webkit-box;overflow:hidden}.HDlONW_delightCard[data-expanded=true] .HDlONW_delightTitle{-webkit-line-clamp:unset;display:block}.HDlONW_delightChevron{width:24px;height:24px;color:var(--obc-text-muted);background:#ffffffb3;border:0;border-radius:8px;flex:none;justify-content:center;align-items:center;font-size:10px;line-height:1;display:inline-flex}.HDlONW_delightDismiss{color:var(--obc-text-muted);cursor:pointer;background:0 0;border:0;border-left:1px solid #eddbe999;border-radius:0 8px 8px 0;padding:3px 7px;font-size:15px;line-height:1;transition:background .15s,color .15s}.HDlONW_delightDismiss:hover:not(:disabled){color:var(--obc-danger);background:#ef7a861f}.HDlONW_delightDismiss:disabled{cursor:wait;opacity:.58}.HDlONW_delightBody{border-top:1px solid #eddbe999;flex-direction:column;gap:8px;padding:2px 12px 12px;display:flex}.HDlONW_delightBody .HDlONW_delightReason{margin-top:8px}.HDlONW_delightReason{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:10px;padding:8px 10px;font-size:11.5px;line-height:1.6}.HDlONW_delightScore{color:var(--obc-brand-strong);font-weight:800}.HDlONW_delightActions{flex-wrap:wrap;gap:6px;display:flex}.HDlONW_delightActions .HDlONW_actionButton{flex:1;min-width:0;padding:6px 8px;font-size:11.5px}.HDlONW_delightComposer{align-items:flex-end;gap:6px;display:flex}.HDlONW_delightComposer .HDlONW_chatInput{flex:1}.HDlONW_settingsOverlay{z-index:12;backdrop-filter:blur(2px);background:#20304a47;flex-direction:column;justify-content:flex-start;display:flex;position:absolute;inset:0}.HDlONW_settingsPanel{background:radial-gradient(circle at 15% 4%, #fb72991f, transparent 30%), var(--obc-bg);border-radius:18px 18px 0 0;flex-direction:column;flex:1;min-height:0;margin-top:8px;display:flex}.HDlONW_settingsHeader{border-bottom:1px solid var(--obc-line);flex:none;justify-content:space-between;align-items:center;padding:14px 14px 10px;display:flex}.HDlONW_settingsHeader h2{color:var(--obc-text);letter-spacing:-.02em;margin:0;font-size:15px;font-weight:800}.HDlONW_settingsBack{width:30px;height:30px;color:var(--obc-text-secondary);cursor:pointer;background:#ffffffc2;border:1px solid #e6edf8eb;border-radius:10px;font-size:14px}.HDlONW_settingsBack:hover{background:var(--obc-brand-soft);color:var(--obc-brand-strong)}.HDlONW_settingsTabs{border-bottom:1px solid var(--obc-line);scrollbar-width:none;flex:none;gap:2px;padding:8px 10px 0;display:flex;overflow-x:auto}.HDlONW_settingsTab{color:var(--obc-text-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:0;border-radius:8px 8px 0 0;padding:6px 10px 8px;font-size:11.5px;font-weight:700}.HDlONW_settingsTab:hover{color:var(--obc-text);background:var(--obc-interactive-bg-hover,#ffffff80)}.HDlONW_settingsTab[data-active=true]{color:var(--obc-brand-strong);box-shadow:inset 0 -2px 0 var(--obc-brand);font-weight:800}.HDlONW_settingsBody{flex-direction:column;flex:1;gap:10px;min-height:0;padding:12px 14px 24px;display:flex;overflow-y:auto}.HDlONW_settingsToastBar{color:var(--obc-success);background:#30b9801f;border:1px solid #30b9804d;border-radius:8px;flex:none;padding:7px 10px;font-size:11.5px}.HDlONW_settingsSection{background:#fffffff0;border:1px solid #e7eef8f5;border-radius:16px;flex-direction:column;gap:10px;padding:12px 14px;display:flex}.HDlONW_settingsSection h3{color:var(--obc-text);align-items:center;gap:6px;margin:0;font-size:13px;font-weight:800;display:flex}.HDlONW_sectionIcon{font-size:14px}.HDlONW_settingsField{flex-direction:column;gap:4px;display:flex}.HDlONW_settingsField>label{color:var(--obc-text-secondary);font-size:11px;font-weight:700}.HDlONW_settingsFieldRow{color:var(--obc-text);align-items:center;gap:8px;font-size:11.5px;display:flex}.HDlONW_settingsFieldRow input[type=checkbox]{accent-color:var(--obc-brand)}.HDlONW_settingsInput{box-sizing:border-box;width:100%;color:var(--obc-text);background:#ffffffe6;border:1px solid #e6edf8eb;border-radius:8px;padding:6px 9px;font-family:inherit;font-size:11.5px}.HDlONW_settingsInput:focus{border-color:var(--obc-sky-blue);outline:none}.HDlONW_settingsHint{color:var(--obc-text-muted);margin:0;font-size:10.5px;line-height:1.5}.HDlONW_settingsActions{align-items:center;gap:8px;display:flex}.HDlONW_settingsToast{color:var(--obc-success);font-size:11px}.HDlONW_settingsInstance{border:1px solid var(--obc-line);background:#ffffffb3;border-radius:12px;flex-direction:column;gap:8px;padding:10px 11px;display:flex}.HDlONW_settingsInstanceHead{color:var(--obc-text);justify-content:space-between;align-items:center;gap:8px;font-size:12px;font-weight:800;display:flex}.HDlONW_settingsSavebar{border:1px solid var(--obc-line);backdrop-filter:blur(14px);box-shadow:var(--obc-shadow-sm);background:#ffffffd1;border-radius:14px;justify-content:flex-end;align-items:center;gap:10px;margin-top:12px;padding:10px 12px;display:flex;position:sticky;bottom:0}.HDlONW_settingsSavebarMsg{color:var(--obc-text-muted);flex:1;font-size:11px}.HDlONW_probeStatus{color:var(--obc-text-muted);word-break:break-word;font-size:11px;line-height:1.5}.HDlONW_probeStatus[data-tone=success]{color:var(--obc-success)}.HDlONW_probeStatus[data-tone=error]{color:var(--obc-danger)}.HDlONW_llmInstanceList{flex-direction:column;gap:8px;display:flex}.HDlONW_llmInstance{border:1px solid var(--obc-line);background:#ffffffb3;border-radius:12px;justify-content:space-between;align-items:center;gap:10px;padding:9px 11px;display:flex}.HDlONW_llmInstanceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.HDlONW_llmInstanceHead{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.HDlONW_llmInstanceName{color:var(--obc-text);font-size:12px;font-weight:800}.HDlONW_llmBadge{background:var(--obc-brand-soft);color:var(--obc-brand-strong);border-radius:999px;padding:3px 7px;font-size:9px;font-weight:800;line-height:1}.HDlONW_llmBadge[data-tone=off]{color:var(--obc-text-muted);background:#8290a829}.HDlONW_llmInstanceDetail{color:var(--obc-text-muted);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.HDlONW_llmInstanceActions{flex:none;gap:6px;display:flex}.HDlONW_chainSection{border-top:1px dashed var(--obc-line);flex-direction:column;gap:8px;margin-top:10px;padding-top:10px;display:flex}.HDlONW_chainHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.HDlONW_chainHead h4{color:var(--obc-text);margin:0;font-size:11.5px;font-weight:800}.HDlONW_chainEditor{flex-direction:column;gap:6px;display:flex}.HDlONW_chainList{flex-direction:column;gap:4px;display:flex}.HDlONW_chainRow{border:1px solid var(--obc-line);background:#ffffff9e;border-radius:10px;align-items:center;gap:4px;padding:5px 8px;display:flex}.HDlONW_chainName{min-width:0;color:var(--obc-text);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:11px;font-weight:700;overflow:hidden}.HDlONW_chainBtn{border:1px solid var(--obc-line);width:22px;height:22px;color:var(--obc-text-muted);cursor:pointer;background:#ffffffb3;border-radius:7px;flex:none;justify-content:center;align-items:center;font-size:10px;line-height:1;display:inline-flex}.HDlONW_chainBtn:hover:not(:disabled){color:var(--obc-brand-strong);border-color:var(--obc-brand)}.HDlONW_chainBtn:disabled{opacity:.35;cursor:default}.HDlONW_chainPicker{align-items:center;gap:6px;display:flex}.HDlONW_chainPicker .HDlONW_settingsInput{flex:1;min-width:0}.HDlONW_moduleRoute{border:1px solid var(--obc-line);background:#ffffff9e;border-radius:12px;margin-bottom:8px;padding:8px 10px}.HDlONW_dialogOverlay{backdrop-filter:blur(3px);z-index:60;background:#141a286b;justify-content:center;align-items:flex-start;padding:6vh 14px;display:flex;position:fixed;inset:0}.HDlONW_dialogCard{border:1px solid var(--obc-line);background:var(--obc-bg);width:min(460px,100%);max-height:86vh;box-shadow:var(--obc-shadow-lg);border-radius:16px;flex-direction:column;gap:10px;padding:14px;display:flex;overflow-y:auto}.HDlONW_dialogHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.HDlONW_dialogHead h3{color:var(--obc-text);margin:0;font-size:13px;font-weight:800}.HDlONW_dialogFields{flex-direction:column;gap:8px;display:flex}.HDlONW_dialogActionRow{align-items:center;gap:6px;display:flex}.HDlONW_dialogActionRow .HDlONW_settingsInput{flex:1;min-width:0}.HDlONW_dialogActions{border-top:1px solid var(--obc-line);flex-wrap:wrap;align-items:center;gap:8px;padding-top:10px;display:flex}.HDlONW_dialogActions .HDlONW_probeStatus{flex:100%;order:-1}.HDlONW_updateRow{color:var(--obc-text-secondary);justify-content:space-between;align-items:baseline;gap:10px;padding:4px 0;font-size:11.5px;display:flex}.HDlONW_updateRow strong{color:var(--obc-text);word-break:break-word;text-align:right;font-weight:800}.HDlONW_panel[data-dark=true]{--obc-bg:#15161a;--obc-sky:#0f1115;--obc-surface:#24262ce0;--obc-surface-strong:#282a31f7;--obc-surface-soft:#212329d1;--obc-line:#ffffff14;--obc-line-strong:#fb729959;--obc-text:#e9ebf1;--obc-text-secondary:#b0b9ca;--obc-text-muted:#8c97ad;--obc-brand-soft:#fb729929;--obc-sky-soft:#5aa9ff29;--obc-shadow-lg:0 20px 40px #00000073;--obc-shadow-sm:0 10px 22px #00000059;background:radial-gradient(circle at 15% 8%,#fb72991a,#0000 30%),radial-gradient(circle at 88% 12%,#5aa9ff1a,#0000 26%),linear-gradient(#17181d 0%,#101216 100%)}.HDlONW_panel[data-dark=true] .HDlONW_iconButton,.HDlONW_panel[data-dark=true] .HDlONW_settingsBack{color:var(--obc-text-secondary);background:#ffffff0f;border-color:#ffffff1a}.HDlONW_panel[data-dark=true] .HDlONW_iconButton:hover,.HDlONW_panel[data-dark=true] .HDlONW_settingsBack:hover{background:var(--obc-brand-soft);color:var(--obc-brand-strong)}.HDlONW_panel[data-dark=true] .HDlONW_tab:hover{background:#ffffff0f}.HDlONW_panel[data-dark=true] .HDlONW_tab[data-active=true]{background:linear-gradient(#ffffff1a,#fb729924);box-shadow:0 10px 18px #0000004d}.HDlONW_panel[data-dark=true] .HDlONW_recHeader,.HDlONW_panel[data-dark=true] .HDlONW_card,.HDlONW_panel[data-dark=true] .HDlONW_recCard,.HDlONW_panel[data-dark=true] .HDlONW_profileGroup,.HDlONW_panel[data-dark=true] .HDlONW_settingsSection,.HDlONW_panel[data-dark=true] .HDlONW_dialogueCard,.HDlONW_panel[data-dark=true] .HDlONW_insightCard,.HDlONW_panel[data-dark=true] .HDlONW_probe,.HDlONW_panel[data-dark=true] .HDlONW_footerItem{box-shadow:none;background:linear-gradient(#26282feb,#21232aeb);border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_card:hover,.HDlONW_panel[data-dark=true] .HDlONW_recCard:hover{border-color:#fb729973;box-shadow:0 14px 26px #0006}.HDlONW_panel[data-dark=true] .HDlONW_delightCard{background:radial-gradient(circle at 100% 0,#fb72991f,#0000 38%),linear-gradient(#2c242cf7,#1e222cf7);border-color:#fb72994d;box-shadow:inset 0 1px #ffffff0d,0 4px 14px #0000004d}.HDlONW_panel[data-dark=true] .HDlONW_delightCard:hover{border-color:#fb72998c;box-shadow:inset 0 1px #ffffff0d,0 12px 28px #0006}.HDlONW_panel[data-dark=true] .HDlONW_delightKicker,.HDlONW_panel[data-dark=true] .HDlONW_topicBadge,.HDlONW_panel[data-dark=true] .HDlONW_chip[data-tone=brand]{background:#fb729929}.HDlONW_panel[data-dark=true] .HDlONW_delightPlatform,.HDlONW_panel[data-dark=true] .HDlONW_stateBadge,.HDlONW_panel[data-dark=true] .HDlONW_platformTag,.HDlONW_panel[data-dark=true] .HDlONW_poolChip,.HDlONW_panel[data-dark=true] .HDlONW_chip,.HDlONW_panel[data-dark=true] .HDlONW_contextBadge{color:var(--obc-text-secondary);background:#ffffff12}.HDlONW_panel[data-dark=true] .HDlONW_delightNav,.HDlONW_panel[data-dark=true] .HDlONW_delightChevron,.HDlONW_panel[data-dark=true] .HDlONW_footerToggle,.HDlONW_panel[data-dark=true] .HDlONW_pendingOpen,.HDlONW_panel[data-dark=true] .HDlONW_contextClear{background:#ffffff12}.HDlONW_panel[data-dark=true] .HDlONW_actionButton{color:var(--obc-text-secondary);background:#ffffff12}.HDlONW_panel[data-dark=true] .HDlONW_actionButton:hover:not(:disabled){color:var(--obc-text);background:#ffffff1f}.HDlONW_panel[data-dark=true] .HDlONW_savedToggle{color:var(--obc-text-secondary);background:#ffffff12}.HDlONW_panel[data-dark=true] .HDlONW_settingsInput,.HDlONW_panel[data-dark=true] .HDlONW_commentInput,.HDlONW_panel[data-dark=true] .HDlONW_chatInput,.HDlONW_panel[data-dark=true] .HDlONW_commentComposer textarea{color:var(--obc-text);background:#181a1fe6;border-color:#ffffff1a}.HDlONW_panel[data-dark=true] .HDlONW_turnSoul,.HDlONW_panel[data-dark=true] .HDlONW_questionObservation{background:#ffffff0f;border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_turnUser{background:#fb729933}.HDlONW_panel[data-dark=true] .HDlONW_profileSummary{background:#242028f0;border-color:#ffffff12}.HDlONW_panel[data-dark=true] .HDlONW_awarenessItem{background:#28241ef0;border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_questionCard{background:linear-gradient(135deg,#1a2433,#141d2c);border-color:#3b82f659}.HDlONW_panel[data-dark=true] .HDlONW_messageCard[data-tone=interest]{background:linear-gradient(135deg,#2b2418,#241d12);border-color:#dd7f2d66}.HDlONW_panel[data-dark=true] .HDlONW_messageCard[data-tone=avoidance]{background:linear-gradient(135deg,#141f2e,#101a26);border-color:#3b82f666}.HDlONW_panel[data-dark=true] .HDlONW_messageCard[data-tone=challenge]{background:linear-gradient(135deg,#221d33,#1b1728);border-color:#7c3aed66}.HDlONW_panel[data-dark=true] .HDlONW_messageCard[data-tone=delight]{background:linear-gradient(135deg,#2e1f26,#261a20);border-color:#fb729966}.HDlONW_panel[data-dark=true] .HDlONW_probe[data-tone=interest]{background:linear-gradient(135deg,#2b2418,#241d12);border-color:#dd7f2d66}.HDlONW_panel[data-dark=true] .HDlONW_probe[data-tone=avoidance]{background:linear-gradient(135deg,#141f2e,#101a26);border-color:#3b82f666}.HDlONW_panel[data-dark=true] .HDlONW_messageBody{color:#b4bece}.HDlONW_panel[data-dark=true] .HDlONW_mbtiDimBar,.HDlONW_panel[data-dark=true] .HDlONW_barTrack,.HDlONW_panel[data-dark=true] .HDlONW_insightConfidenceBar,.HDlONW_panel[data-dark=true] .HDlONW_mbtiConfidence{background:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_drawerPanel,.HDlONW_panel[data-dark=true] .HDlONW_settingsPanel{background:radial-gradient(circle at 15% 4%,#fb729914,#0000 30%),#15161a}.HDlONW_panel[data-dark=true] .HDlONW_settingsInstance{background:#ffffff0a;border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_pendingItem{border-top-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_contextBar,.HDlONW_panel[data-dark=true] .HDlONW_activityFooter{background:#212329d9;border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_subTabs{background:#ffffff0a;border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_subTab[data-active=true]{background:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_delightReason{color:var(--obc-text-secondary);background:#ffffff0f}.HDlONW_panel[data-dark=true] .HDlONW_delightBody{border-top-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_delightChevron{color:var(--obc-text-secondary);background:#ffffff12}.HDlONW_panel[data-dark=true] .HDlONW_delightDismiss{border-left-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_footerHint{color:#c3cddd}.HDlONW_panel[data-dark=true] .HDlONW_settingsSavebar,.HDlONW_panel[data-dark=true] .HDlONW_llmInstance,.HDlONW_panel[data-dark=true] .HDlONW_chainRow,.HDlONW_panel[data-dark=true] .HDlONW_moduleRoute{background:#24262ce0;border-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_chainBtn{background:#ffffff0f;border-color:#ffffff1a}.HDlONW_panel[data-dark=true] .HDlONW_dialogCard{background:radial-gradient(circle at 15% 4%,#fb729914,#0000 30%),#15161a;border-color:#ffffff1a}.HDlONW_panel[data-dark=true] .HDlONW_llmBadge{background:#fb729933}.HDlONW_panel[data-dark=true] .HDlONW_actionButton:disabled{opacity:.66;color:#9aa4b8}.HDlONW_panel[data-dark=true] .HDlONW_recCover{background:linear-gradient(145deg,#fb729924,#5aa9ff1f),#1e2028f5}.HDlONW_panel[data-dark=true] .HDlONW_delightCover{background:linear-gradient(#282a31f5,#212329f5),linear-gradient(145deg,#fb729929,#5aa9ff1a);border-color:#ffffff24;box-shadow:inset 0 1px #ffffff0f,0 2px 8px #0000004d}.HDlONW_panel[data-dark=true] .HDlONW_delightCard:hover .HDlONW_delightCover{box-shadow:inset 0 1px #ffffff0f,0 8px 18px #0000006b}.HDlONW_panel[data-dark=true] .HDlONW_delightHeroFallback{color:var(--obc-text);background:linear-gradient(145deg,#fb729929,#5aa9ff1f)}.HDlONW_panel[data-dark=true] .HDlONW_pinnedFooter{background:#15161ab3;border-top-color:#ffffff14}.HDlONW_panel[data-dark=true] .HDlONW_pinnedFooter .HDlONW_activityFooter{box-shadow:none;background:0 0;border:0}.HDlONW_panel[data-dark=true] .HDlONW_starButton{background:linear-gradient(#2c242cf7,#fb72991f);border-color:#fb729952}.HDlONW_sidebarButton{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary,#20304a);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:13px;font-weight:600;line-height:22px;display:flex;overflow:hidden}.HDlONW_sidebarButton:hover{background:var(--dsw-alias-interactive-bg-hover,#0000000d)}.HDlONW_sidebarButton[data-active=true]{color:#f65788;background:#fb72991f}.HDlONW_sidebarButton[data-wide=false]{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.HDlONW_sidebarButtonIcon{object-fit:cover;background:linear-gradient(135deg,#fb7299,#ff8cb0);border-radius:6px;flex:none;width:18px;height:18px;display:block;box-shadow:0 4px 8px #fb729940}.HDlONW_sidebarButtonLabel{white-space:nowrap;overflow:hidden}.obc-panel-handle:after{content:\"\";background:#20304a2e;border-radius:2px;width:2px;height:32px;transition:background .15s;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.obc-panel-handle:hover:after{background:#fb72998c}";
		...
		var panel_module_css_default = {
			"settingsInstanceHead": "HDlONW_settingsInstanceHead",
			"tabBar": "HDlONW_tabBar",
			"badgeRow": "HDlONW_badgeRow",
			"settingsSavebar": "HDlONW_settingsSavebar",
			"tab": "HDlONW_tab",
			"turnSoul": "HDlONW_turnSoul",
			"footerCopy": "HDlONW_footerCopy",
			"awarenessItemDate": "HDlONW_awarenessItemDate",
			"hint": "HDlONW_hint",
			"insightConfidenceLabel": "HDlONW_insightConfidenceLabel",
			"dialogueEvidence": "HDlONW_dialogueEvidence",
			"messageCard": "HDlONW_messageCard",
			"contextClear": "HDlONW_contextClear",
			"chipWeight": "HDlONW_chipWeight",
			"spinner": "HDlONW_spinner",
			"delightKicker": "HDlONW_delightKicker",
			"probeDomain": "HDlONW_probeDomain",
			"obcSpin": "HDlONW_obcSpin",
			"confirmItem": "HDlONW_confirmItem",
			"mbtiTypeLabel": "HDlONW_mbtiTypeLabel",
			"loadingRow": "HDlONW_loadingRow",
			"interestDomain": "HDlONW_interestDomain",
			"brandCopy": "HDlONW_brandCopy",
			"drawerEmpty": "HDlONW_drawerEmpty",
			"awarenessEmotion": "HDlONW_awarenessEmotion",
			"status": "HDlONW_status",
			"profileLayer": "HDlONW_profileLayer",
			"savedToggle": "HDlONW_savedToggle",
			"delightCoverScrim": "HDlONW_delightCoverScrim",
			"sectionIcon": "HDlONW_sectionIcon",
			"cardTitle": "HDlONW_cardTitle",
			"viewKicker": "HDlONW_viewKicker",
			"poolChipLabel": "HDlONW_poolChipLabel",
			"pendingKind": "HDlONW_pendingKind",
			"dialogueState": "HDlONW_dialogueState",
			"recHeaderTitle": "HDlONW_recHeaderTitle",
			"sectionTitle": "HDlONW_sectionTitle",
			"mbtiConfidence": "HDlONW_mbtiConfidence",
			"mbtiDimBar": "HDlONW_mbtiDimBar",
			"recTitle": "HDlONW_recTitle",
			"mbtiTypeRow": "HDlONW_mbtiTypeRow",
			"awarenessItem": "HDlONW_awarenessItem",
			"loadMore": "HDlONW_loadMore",
			"commentRow": "HDlONW_commentRow",
			"syncLineDetail": "HDlONW_syncLineDetail",
			"llmInstanceDetail": "HDlONW_llmInstanceDetail",
			"footerToggle": "HDlONW_footerToggle",
			"awarenessDate": "HDlONW_awarenessDate",
			"recKicker": "HDlONW_recKicker",
			"poolChip": "HDlONW_poolChip",
			"insightNote": "HDlONW_insightNote",
			"sidebarButtonLabel": "HDlONW_sidebarButtonLabel",
			"platformTag": "HDlONW_platformTag",
			"barLabel": "HDlONW_barLabel",
			"syncBadgeRow": "HDlONW_syncBadgeRow",
			"probeReason": "HDlONW_probeReason",
			"drawerEmptyTitle": "HDlONW_drawerEmptyTitle",
			"poolChips": "HDlONW_poolChips",
			"chatInput": "HDlONW_chatInput",
			"awarenessRow": "HDlONW_awarenessRow",
			"confirmCount": "HDlONW_confirmCount",
			"cardBody": "HDlONW_cardBody",
			"card": "HDlONW_card",
			"recCard": "HDlONW_recCard",
			"pendingOpen": "HDlONW_pendingOpen",
			"moduleRoute": "HDlONW_moduleRoute",
			"delightMain": "HDlONW_delightMain",
			"expression": "HDlONW_expression",
			"delightScorePill": "HDlONW_delightScorePill",
			"insightCard": "HDlONW_insightCard",
			"settingsField": "HDlONW_settingsField",
			"chainPicker": "HDlONW_chainPicker",
			"coverWrap": "HDlONW_coverWrap",
			"llmInstanceMain": "HDlONW_llmInstanceMain",
			"awarenessTrend": "HDlONW_awarenessTrend",
			"turnUser": "HDlONW_turnUser",
			"drawerOverlay": "HDlONW_drawerOverlay",
			"awarenessHeader": "HDlONW_awarenessHeader",
			"profileCard": "HDlONW_profileCard",
			"insightHead": "HDlONW_insightHead",
			"questionInterpretation": "HDlONW_questionInterpretation",
			"chatInputRow": "HDlONW_chatInputRow",
			"settingsToastBar": "HDlONW_settingsToastBar",
			"dialogActionRow": "HDlONW_dialogActionRow",
			"updateRow": "HDlONW_updateRow",
			"insightValidated": "HDlONW_insightValidated",
			"chainEditor": "HDlONW_chainEditor",
			"awarenessObservation": "HDlONW_awarenessObservation",
			"delightTitleWrap": "HDlONW_delightTitleWrap",
			"settingsBody": "HDlONW_settingsBody",
			"empty": "HDlONW_empty",
			"probeConfidence": "HDlONW_probeConfidence",
			"messageBody": "HDlONW_messageBody",
			"mbtiDimPole": "HDlONW_mbtiDimPole",
			"footerItemKind": "HDlONW_footerItemKind",
			"settingsRow": "HDlONW_settingsRow",
			"settingsActions": "HDlONW_settingsActions",
			"interestTreeLabel": "HDlONW_interestTreeLabel",
			"cardTurn": "HDlONW_cardTurn",
			"probeActions": "HDlONW_probeActions",
			"action_reject": "HDlONW_action_reject",
			"watchToggle": "HDlONW_watchToggle",
			"delightReason": "HDlONW_delightReason",
			"pendingConfidence": "HDlONW_pendingConfidence",
			"confirmPanel": "HDlONW_confirmPanel",
			"starCount": "HDlONW_starCount",
			"probeStatus": "HDlONW_probeStatus",
			"delightText": "HDlONW_delightText",
			"footerHistory": "HDlONW_footerHistory",
			"dialogHead": "HDlONW_dialogHead",
			"delightTitle": "HDlONW_delightTitle",
			"settingsTabs": "HDlONW_settingsTabs",
			"pendingItem": "HDlONW_pendingItem",
			"starToggle": "HDlONW_starToggle",
			"insightEvidence": "HDlONW_insightEvidence",
			"dialogOverlay": "HDlONW_dialogOverlay",
			"messagePrompt": "HDlONW_messagePrompt",
			"syncChip": "HDlONW_syncChip",
			"dialogueAction": "HDlONW_dialogueAction",
			"interestDomainHeader": "HDlONW_interestDomainHeader",
			"commentInput": "HDlONW_commentInput",
			"barFill": "HDlONW_barFill",
			"delightActions": "HDlONW_delightActions",
			"llmInstance": "HDlONW_llmInstance",
			"chatSend": "HDlONW_chatSend",
			"action_confirm": "HDlONW_action_confirm",
			"chainRow": "HDlONW_chainRow",
			"badge": "HDlONW_badge",
			"settingsInstance": "HDlONW_settingsInstance",
			"delightThumbFallback": "HDlONW_delightThumbFallback",
			"stats": "HDlONW_stats",
			"brandMark": "HDlONW_brandMark",
			"chainName": "HDlONW_chainName",
			"insightConfidenceRow": "HDlONW_insightConfidenceRow",
			"delightHero": "HDlONW_delightHero",
			"interestDomainHead": "HDlONW_interestDomainHead",
			"dialogueKicker": "HDlONW_dialogueKicker",
			"replyQuote": "HDlONW_replyQuote",
			"barPct": "HDlONW_barPct",
			"insightConfidenceFill": "HDlONW_insightConfidenceFill",
			"poolChipValue": "HDlONW_poolChipValue",
			"delightChevron": "HDlONW_delightChevron",
			"footerHead": "HDlONW_footerHead",
			"llmBadge": "HDlONW_llmBadge",
			"recCoverText": "HDlONW_recCoverText",
			"subTabs": "HDlONW_subTabs",
			"chip": "HDlONW_chip",
			"topicBadge": "HDlONW_topicBadge",
			"questionObservation": "HDlONW_questionObservation",
			"recHeader": "HDlONW_recHeader",
			"profilePortraitP": "HDlONW_profilePortraitP",
			"delightDismiss": "HDlONW_delightDismiss",
			"contextInterpretation": "HDlONW_contextInterpretation",
			"delightHeader": "HDlONW_delightHeader",
			"activityRow": "HDlONW_activityRow",
			"body": "HDlONW_body",
			"actionButton": "HDlONW_actionButton",
			"subTab": "HDlONW_subTab",
			"drawerHeader": "HDlONW_drawerHeader",
			"dialogActions": "HDlONW_dialogActions",
			"sidebarButton": "HDlONW_sidebarButton",
			"messageActions": "HDlONW_messageActions",
			"coverCorner": "HDlONW_coverCorner",
			"dialogFields": "HDlONW_dialogFields",
			"bellBadge": "HDlONW_bellBadge",
			"dialogueTitle": "HDlONW_dialogueTitle",
			"footerItem": "HDlONW_footerItem",
			"insightConfidenceBar": "HDlONW_insightConfidenceBar",
			"profileSummary": "HDlONW_profileSummary",
			"insightTitle": "HDlONW_insightTitle",
			"settingsSavebarMsg": "HDlONW_settingsSavebarMsg",
			"delightCard": "HDlONW_delightCard",
			"syncMessage": "HDlONW_syncMessage",
			"syncResults": "HDlONW_syncResults",
			"contextValue": "HDlONW_contextValue",
			"settingsBack": "HDlONW_settingsBack",
			"messageTitle": "HDlONW_messageTitle",
			"turn": "HDlONW_turn",
			"contextBar": "HDlONW_contextBar",
			"activityFooter": "HDlONW_activityFooter",
			"contextBarHead": "HDlONW_contextBarHead",
			"interestDomainName": "HDlONW_interestDomainName",
			"delightPlatform": "HDlONW_delightPlatform",
			"statusText": "HDlONW_statusText",
			"settingsTab": "HDlONW_settingsTab",
			"profilePhaseCopy": "HDlONW_profilePhaseCopy",
			"thumbFallback": "HDlONW_thumbFallback",
			"activityLine": "HDlONW_activityLine",
			"footerHint": "HDlONW_footerHint",
			"mbtiDimPct": "HDlONW_mbtiDimPct",
			"mbtiContainer": "HDlONW_mbtiContainer",
			"dialogueActions": "HDlONW_dialogueActions",
			"llmInstanceName": "HDlONW_llmInstanceName",
			"recHeaderCopy": "HDlONW_recHeaderCopy",
			"pendingObservation": "HDlONW_pendingObservation",
			"chainSection": "HDlONW_chainSection",
			"syncToolbar": "HDlONW_syncToolbar",
			"footerHeadline": "HDlONW_footerHeadline",
			"header": "HDlONW_header",
			"dialogueCard": "HDlONW_dialogueCard",
			"spacer": "HDlONW_spacer",
			"settings": "HDlONW_settings",
			"viewIntro": "HDlONW_viewIntro",
			"barRow": "HDlONW_barRow",
			"drawerEmptySubtitle": "HDlONW_drawerEmptySubtitle",
			"feedbackStatus": "HDlONW_feedbackStatus",
			"delightBody": "HDlONW_delightBody",
			"cardMeta": "HDlONW_cardMeta",
			"profileGroup": "HDlONW_profileGroup",
			"settingsOverlay": "HDlONW_settingsOverlay",
			"syncLine": "HDlONW_syncLine",
			"pendingInterpretation": "HDlONW_pendingInterpretation",
			"domainWeight": "HDlONW_domainWeight",
			"delightScore": "HDlONW_delightScore",
			"delightHeroFallback": "HDlONW_delightHeroFallback",
			"settingsSection": "HDlONW_settingsSection",
			"delightKickerLine": "HDlONW_delightKickerLine",
			"pendingCopy": "HDlONW_pendingCopy",
			"action_discuss": "HDlONW_action_discuss",
			"delightCounter": "HDlONW_delightCounter",
			"settingsHint": "HDlONW_settingsHint",
			"delightComposer": "HDlONW_delightComposer",
			"sidebarButtonIcon": "HDlONW_sidebarButtonIcon",
			"statusDot": "HDlONW_statusDot",
			"barTrack": "HDlONW_barTrack",
			"insightEvidenceList": "HDlONW_insightEvidenceList",
			"stateBadge": "HDlONW_stateBadge",
			"syncLineText": "HDlONW_syncLineText",
			"confirmTitle": "HDlONW_confirmTitle",
			"error": "HDlONW_error",
			"chipRow": "HDlONW_chipRow",
			"toolbar": "HDlONW_toolbar",
			"delightThumb": "HDlONW_delightThumb",
			"footerItemMeta": "HDlONW_footerItemMeta",
			"contextRow": "HDlONW_contextRow",
			"activityTime": "HDlONW_activityTime",
			"awarenessList": "HDlONW_awarenessList",
			"interestDomainWeight": "HDlONW_interestDomainWeight",
			"messageType": "HDlONW_messageType",
			"footerItemSummary": "HDlONW_footerItemSummary",
			"turnStatus": "HDlONW_turnStatus",
			"probeHead": "HDlONW_probeHead",
			"questionCard": "HDlONW_questionCard",
			"mbtiDimensions": "HDlONW_mbtiDimensions",
			"settingsHeader": "HDlONW_settingsHeader",
			"mbtiDimBarFill": "HDlONW_mbtiDimBarFill",
			"drawerTitle": "HDlONW_drawerTitle",
			"recBody": "HDlONW_recBody",
			"settingsToast": "HDlONW_settingsToast",
			"llmInstanceList": "HDlONW_llmInstanceList",
			"brandTitle": "HDlONW_brandTitle",
			"brand": "HDlONW_brand",
			"thumb": "HDlONW_thumb",
			"pinnedFooter": "HDlONW_pinnedFooter",
			"delightCover": "HDlONW_delightCover",
			"panel": "HDlONW_panel",
			"starButton": "HDlONW_starButton",
			"portrait": "HDlONW_portrait",
			"settingsFieldRow": "HDlONW_settingsFieldRow",
			"confirmToggle": "HDlONW_confirmToggle",
			"chainHead": "HDlONW_chainHead",
			"settingsInput": "HDlONW_settingsInput",
			"syncInlineDetail": "HDlONW_syncInlineDetail",
			"commentComposer": "HDlONW_commentComposer",
			"contextLabel": "HDlONW_contextLabel",
			"chainList": "HDlONW_chainList",
			"contextTitle": "HDlONW_contextTitle",
			"contextObservation": "HDlONW_contextObservation",
			"chainBtn": "HDlONW_chainBtn",
			"llmInstanceActions": "HDlONW_llmInstanceActions",
			"interestTree": "HDlONW_interestTree",
			"recCover": "HDlONW_recCover",
			"starLabel": "HDlONW_starLabel",
			"delightRow": "HDlONW_delightRow",
			"mbtiDimRow": "HDlONW_mbtiDimRow",
			"cardActions": "HDlONW_cardActions",
			"dialogCard": "HDlONW_dialogCard",
			"settingsPanel": "HDlONW_settingsPanel",
			"llmInstanceHead": "HDlONW_llmInstanceHead",
			"contextBadge": "HDlONW_contextBadge",
			"drawerPanel": "HDlONW_drawerPanel",
			"probe": "HDlONW_probe",
			"iconButton": "HDlONW_iconButton",
			"delightNav": "HDlONW_delightNav"
		};
		//#endregion
		...
		*/
		...
		function SavedList(props) {
			...
			const startSync = (0, react.useCallback)(async () => {
