window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-openbiliclaw/src/client/panel.module.css.mjs
		const css = ".K1gtda_panel{--obc-bg:#fffafc;--obc-sky:#f2f8ff;--obc-surface:#ffffffd6;--obc-surface-strong:#fffffff7;--obc-surface-soft:#ffffffb8;--obc-line:#d9e3f2f2;--obc-line-strong:#f7adca80;--obc-text:#20304a;--obc-text-secondary:#60708c;--obc-text-muted:#8290a8;--obc-brand:#fb7299;--obc-brand-strong:#f65788;--obc-brand-soft:#fb72991f;--obc-sky-blue:#5aa9ff;--obc-sky-soft:#5aa9ff24;--obc-success:#30b980;--obc-danger:#ef7a86;--obc-shadow-lg:0 20px 40px #384c701f;--obc-shadow-sm:0 10px 22px #495d8214;min-width:0;height:100%;color:var(--obc-text);background:radial-gradient(circle at 15% 8%, #fb729929, transparent 30%), radial-gradient(circle at 88% 12%, #5aa9ff2e, transparent 26%), linear-gradient(180deg, var(--obc-bg) 0%, var(--obc-sky) 100%);background-attachment:fixed;flex-direction:column;font-family:Avenir Next,PingFang SC,Hiragino Sans GB,Microsoft YaHei,sans-serif;display:flex;position:relative;overflow:hidden}.K1gtda_panel button,.K1gtda_panel input,.K1gtda_panel textarea{font-family:inherit}.K1gtda_header{flex:none;align-items:center;gap:6px;padding:14px 14px 10px;display:flex}.K1gtda_brand{flex:1;align-items:center;gap:9px;min-width:0;display:flex}.K1gtda_brandMark{object-fit:cover;background:linear-gradient(135deg, var(--obc-brand), #ff8cb0);border-radius:10px;flex:none;width:30px;height:30px;display:block;box-shadow:0 8px 16px #fb729940}.K1gtda_brandCopy{flex-direction:column;min-width:0;display:flex}.K1gtda_brandTitle{color:var(--obc-text);letter-spacing:-.02em;white-space:nowrap;text-overflow:ellipsis;font-size:14px;font-weight:800;overflow:hidden}.K1gtda_status{align-items:center;gap:4px;display:flex}.K1gtda_statusDot{background:var(--obc-danger);border-radius:50%;width:6px;height:6px}.K1gtda_statusDot[data-online=true]{background:var(--obc-success)}.K1gtda_statusText{color:var(--obc-text-muted);font-size:10px}.K1gtda_iconButton{width:30px;height:30px;color:var(--obc-text-secondary);cursor:pointer;background:#ffffffc2;border:1px solid #e6edf8eb;border-radius:10px;flex:none;justify-content:center;align-items:center;transition:background .15s,transform .15s;display:flex;position:relative}.K1gtda_starButton{height:30px;color:var(--obc-brand-strong);cursor:pointer;background:linear-gradient(#fffcfef5,#fb72991a);border:1px solid #fb729947;border-radius:10px;flex:none;align-items:center;gap:5px;padding:0 9px;transition:transform .15s,border-color .15s,box-shadow .15s;display:inline-flex}.K1gtda_starButton:hover{border-color:#fb72998c;transform:translateY(-1px);box-shadow:0 6px 14px #fb72992e}.K1gtda_starCount{color:var(--obc-text-secondary);font-size:10.5px;font-weight:800;line-height:1}.K1gtda_starLabel{color:var(--obc-brand-strong);font-size:10.5px;font-weight:800;line-height:1}.K1gtda_iconButton:hover{background:var(--obc-brand-soft);color:var(--obc-brand-strong);transform:translateY(-1px)}.K1gtda_bellBadge{background:var(--obc-brand);color:#fff;min-width:16px;height:16px;box-shadow:0 0 0 2px var(--obc-bg);border-radius:8px;justify-content:center;align-items:center;padding:0 4px;font-size:9px;font-weight:700;display:flex;position:absolute;top:-5px;right:-5px}.K1gtda_settings{border-bottom:1px solid var(--obc-line);flex-direction:column;gap:6px;padding:0 14px 10px;display:flex}.K1gtda_settingsRow{align-items:center;gap:6px;display:flex}.K1gtda_settingsInput{min-width:0;color:var(--obc-text);background:#ffffffd9;border:1px solid #e6edf8eb;border-radius:8px;flex:1;padding:6px 9px;font-size:11px}.K1gtda_hint{color:var(--obc-text-muted);font-size:10.5px;line-height:1.5}.K1gtda_tabBar{flex:none;gap:6px;padding:0 14px 12px;display:flex}.K1gtda_tab{min-width:0;min-height:48px;color:var(--obc-text-secondary);cursor:pointer;background:0 0;border:0;border-radius:16px;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:3px;padding:7px 4px;font-size:10px;font-weight:700;line-height:1.3;transition:background .18s,color .18s,box-shadow .18s,transform .18s;display:flex}.K1gtda_tab:hover{color:var(--obc-text);background:#ffffff85}.K1gtda_tab[data-active=true]{color:var(--obc-brand-strong);background:linear-gradient(#fffffffa,#fff0f6fa);transform:translateY(-1px);box-shadow:0 10px 18px #fb729924}.K1gtda_badge{background:var(--obc-brand);color:#fff;text-align:center;vertical-align:1px;border-radius:8px;min-width:15px;height:15px;margin-left:3px;padding:0 4px;font-size:9px;font-weight:700;line-height:15px;display:inline-block}.K1gtda_body{flex-direction:column;flex:1;gap:12px;min-height:0;padding:2px 14px 20px;display:flex;overflow-y:auto}.K1gtda_body>*{flex-shrink:0}.K1gtda_empty{color:var(--obc-text-muted);text-align:center;padding:26px 10px;font-size:12px;line-height:1.7}.K1gtda_error{color:var(--obc-danger);white-space:pre-wrap;background:#ef7a861a;border:1px solid #ef7a8640;border-radius:10px;padding:8px 10px;font-size:11.5px;line-height:1.5}.K1gtda_toolbar{flex:none;align-items:center;gap:6px;display:flex}.K1gtda_spacer{flex:1}.K1gtda_sectionTitle{color:var(--obc-text);margin:4px 0 2px;font-size:12px;font-weight:800}.K1gtda_recHeader{box-shadow:var(--obc-shadow-sm);background:linear-gradient(#ffffffe6,#fafbffe6);border:1px solid #e6edf8eb;border-radius:18px;align-items:flex-start;gap:8px;padding:14px;display:flex}.K1gtda_recHeaderCopy{flex:1;min-width:0}.K1gtda_recKicker{letter-spacing:.08em;text-transform:uppercase;color:var(--obc-brand);font-size:9px;font-weight:700}.K1gtda_recHeaderTitle{color:var(--obc-text);letter-spacing:-.02em;margin-top:2px;font-size:16px;font-weight:800;line-height:1.35}.K1gtda_poolChips{flex-direction:column;gap:4px;margin-top:8px;display:flex}.K1gtda_poolChip{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:6px;justify-content:space-between;gap:8px;padding:3px 7px;font-size:10px;line-height:1.5;display:flex}.K1gtda_poolChipLabel{color:var(--obc-text-muted);flex:none;font-weight:600}.K1gtda_poolChipValue{text-align:right;word-break:break-word}.K1gtda_delightCard{background:linear-gradient(#fffcfefa,#fcf8fffa);border:1px solid #fb729947;border-radius:18px;flex-direction:column;gap:6px;padding:12px;display:flex;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.K1gtda_delightKickerLine{align-items:center;gap:6px;display:flex}.K1gtda_delightKicker{color:var(--obc-brand-strong);font-size:12px;font-weight:800}.K1gtda_delightCounter{color:var(--obc-text-muted);margin-left:auto;font-size:10px}.K1gtda_delightTitle{color:var(--obc-text);letter-spacing:-.01em;-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:14px;font-weight:800;line-height:1.4;display:-webkit-box;overflow:hidden}.K1gtda_card{box-shadow:var(--obc-shadow-sm);background:linear-gradient(#ffffffeb,#fafbffeb);border:1px solid #e6edf8eb;border-radius:16px;align-items:flex-start;gap:10px;padding:10px;transition:border-color .18s,box-shadow .18s;display:flex}.K1gtda_card:hover{border-color:var(--obc-line-strong);box-shadow:0 14px 26px #fb72991a}.K1gtda_thumb{object-fit:cover;background:linear-gradient(145deg,#fb72991f,#5aa9ff1a);border-radius:10px;flex:none;width:84px;height:58px;display:block}.K1gtda_thumbFallback{width:84px;height:58px;color:var(--obc-text-secondary);background:linear-gradient(145deg,#fb72991f,#5aa9ff1a);border-radius:10px;flex:none;justify-content:center;align-items:center;font-size:16px;font-weight:700;display:flex}.K1gtda_coverWrap{flex:none;position:relative}.K1gtda_coverCorner{color:#fff;background:#20304a9e;border-radius:4px;padding:0 4px;font-size:8px;font-weight:700;line-height:13px;position:absolute;top:4px;left:4px}.K1gtda_cardBody{flex-direction:column;flex:1;align-self:center;gap:3px;min-width:0;display:flex}.K1gtda_cardTitle{min-height:36px;color:var(--obc-text);letter-spacing:-.01em;-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:13px;font-weight:800;line-height:1.4;display:-webkit-box;overflow:hidden}.K1gtda_cardMeta{color:var(--obc-text-muted);flex-wrap:wrap;align-items:center;gap:6px;font-size:10px;display:flex}.K1gtda_platformTag{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:4px;padding:0 5px;font-size:9px;font-weight:600;line-height:15px}.K1gtda_badgeRow{flex-wrap:wrap;align-items:center;gap:5px;display:flex}.K1gtda_stateBadge{color:var(--obc-text-muted);background:#f0f6ffe6;border-radius:5px;padding:0 5px;font-size:9px;line-height:15px}.K1gtda_topicBadge{background:var(--obc-brand-soft);color:var(--obc-brand-strong);border-radius:5px;padding:0 5px;font-size:9px;font-weight:700;line-height:15px}.K1gtda_contextBadge{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:4px;padding:0 5px;font-size:9px;font-weight:600;line-height:15px}.K1gtda_contextBadge[data-kind=restored]{color:var(--obc-success);background:#30b9801f}.K1gtda_contextBadge[data-kind=removed]{color:var(--obc-danger);background:#ef7a861f}.K1gtda_stats{color:var(--obc-text-muted);flex-wrap:wrap;gap:8px;font-size:10px;display:flex}.K1gtda_expression{color:var(--obc-text-secondary);-webkit-line-clamp:3;-webkit-box-orient:vertical;font-size:11.5px;line-height:1.6;display:-webkit-box;overflow:hidden}.K1gtda_feedbackStatus{color:var(--obc-text-muted);min-height:13px;font-size:10.5px;line-height:1.4}.K1gtda_cardActions{flex-wrap:wrap;gap:6px;margin-top:3px;display:flex}.K1gtda_actionButton{cursor:pointer;min-height:26px;color:var(--obc-text-secondary);background:#f0f6ffe6;border:0;border-radius:11px;padding:4px 10px;font-size:11px;font-weight:600;line-height:1.2;transition:background .18s,color .18s,box-shadow .18s,transform .18s}.K1gtda_actionButton:hover:not(:disabled){color:var(--obc-text);transform:translateY(-1px)}.K1gtda_actionButton:disabled{cursor:not-allowed;opacity:.6;transform:none}.K1gtda_actionButton[data-primary=true]{background:linear-gradient(135deg, var(--obc-brand), #ff8cb0);color:#fff;font-weight:800;box-shadow:0 8px 14px #fb729938}.K1gtda_actionButton[data-primary=true]:hover:not(:disabled){background:linear-gradient(135deg, var(--obc-brand-strong), #ff7ca7);color:#fff}.K1gtda_actionButton[data-danger=true]:hover:not(:disabled){color:var(--obc-danger);background:#ef7a861f}.K1gtda_commentRow{align-items:center;gap:6px;display:flex}.K1gtda_commentInput{min-width:0;color:var(--obc-text);background:#ffffffd9;border:1px solid #e6edf8eb;border-radius:8px;flex:1;padding:4px 8px;font-size:11px}.K1gtda_commentInput:focus{border-color:var(--obc-sky-blue);outline:none}.K1gtda_loadMore{color:var(--obc-text-secondary);cursor:pointer;background:0 0;border:1px dashed #d9e3f2f2;border-radius:10px;padding:7px;font-size:11.5px}.K1gtda_loadMore:hover:not(:disabled){color:var(--obc-text);border-color:var(--obc-sky-blue)}.K1gtda_loadMore:disabled{opacity:.5}.K1gtda_loadingRow{color:var(--obc-text-muted);justify-content:center;align-items:center;gap:8px;padding:10px 0 4px;font-size:11px;font-weight:700;display:flex}.K1gtda_spinner{border:2px solid #fb729938;border-top-color:var(--obc-brand);border-radius:999px;width:14px;height:14px;animation:.8s linear infinite K1gtda_obcSpin}@keyframes K1gtda_obcSpin{to{transform:rotate(360deg)}}.K1gtda_activityFooter{border-top:1px solid var(--obc-line);padding-top:8px}.K1gtda_activityRow{color:var(--obc-text-secondary);gap:8px;padding:4px 0;font-size:11px;line-height:1.5;display:flex}.K1gtda_activityTime{color:var(--obc-text-muted);flex:none;padding-top:1px;font-size:10px}.K1gtda_subTabs{border:1px solid var(--obc-line);background:#ffffffa8;border-radius:12px;flex:none;gap:4px;padding:4px;display:flex}.K1gtda_subTab{color:var(--obc-text-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:0;border-radius:9px;flex:1;padding:6px 4px;font-size:10.5px;font-weight:700;line-height:1.4}.K1gtda_subTab:hover{color:var(--obc-text)}.K1gtda_subTab[data-active=true]{background:var(--obc-surface-strong);color:var(--obc-brand-strong);box-shadow:var(--obc-shadow-sm)}.K1gtda_turn{flex-direction:column;gap:3px;display:flex}.K1gtda_turnUser,.K1gtda_turnSoul{white-space:pre-wrap;word-break:break-word;border-radius:14px;padding:8px 11px;font-size:12px;line-height:1.6}.K1gtda_turnUser{background:var(--obc-brand-soft);color:var(--obc-text);align-self:flex-end;max-width:92%}.K1gtda_turnSoul{border:1px solid var(--obc-line);color:var(--obc-text);background:#ffffffe6;align-self:flex-start;max-width:92%}.K1gtda_turnStatus{color:var(--obc-text-muted);align-self:flex-end;font-size:10px}.K1gtda_chatInputRow{border-top:1px solid var(--obc-line);flex:none;gap:6px;padding-top:8px;display:flex}.K1gtda_chatInput{min-width:0;color:var(--obc-text);resize:none;background:#ffffffe6;border:1px solid #e6edf8eb;border-radius:12px;flex:1;padding:8px 10px;font-size:12px}.K1gtda_chatInput:focus{border-color:var(--obc-sky-blue);outline:none}.K1gtda_chatSend{background:linear-gradient(135deg, var(--obc-brand), #ff8cb0);color:#fff;cursor:pointer;border:0;border-radius:12px;padding:0 14px;font-size:12px;font-weight:800;box-shadow:0 8px 14px #fb729938}.K1gtda_chatSend:hover:not(:disabled){background:linear-gradient(135deg, var(--obc-brand-strong), #ff7ca7)}.K1gtda_chatSend:disabled{opacity:.6}.K1gtda_confirmPanel{border:1px solid var(--obc-line);background:#ffffffd9;border-radius:14px;flex:none;overflow:hidden}.K1gtda_confirmToggle{width:100%;color:var(--obc-text);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:6px;padding:9px 11px;font-size:12px;font-weight:800;display:flex}.K1gtda_confirmToggle:hover{background:var(--obc-brand-soft)}.K1gtda_confirmCount{color:#fff;background:var(--obc-brand);border-radius:8px;margin-left:auto;padding:1px 7px;font-size:10px;font-weight:700}.K1gtda_confirmItem{border-top:1px solid var(--obc-line);flex-direction:column;gap:4px;padding:10px 11px;display:flex}.K1gtda_confirmTitle{color:var(--obc-text);font-size:12px;font-weight:800;line-height:1.5}.K1gtda_cardTurn{border:1px solid var(--obc-line);background:#ffffffe6;border-radius:14px;flex-direction:column;gap:4px;padding:10px 11px;display:flex}.K1gtda_insightEvidence{color:var(--obc-text-secondary);white-space:pre-wrap;font-size:11px;line-height:1.55}.K1gtda_insightNote{color:var(--obc-text-muted);font-size:10.5px}.K1gtda_probeConfidence{color:var(--obc-text-muted);font-size:10px}.K1gtda_portrait{color:var(--obc-text);border:1px solid var(--obc-line);background:#ffffffd9;border-radius:14px;padding:11px 12px;font-size:12.5px;line-height:1.7}.K1gtda_chipRow{flex-wrap:wrap;gap:5px;display:flex}.K1gtda_chip{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:11px;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:1.6}.K1gtda_chip[data-kind=dislike]{color:var(--obc-danger);background:#ef7a861f}.K1gtda_interestDomain{margin-bottom:6px}.K1gtda_interestDomainHead{color:var(--obc-text);align-items:center;gap:6px;font-size:12px;font-weight:800;display:flex}.K1gtda_domainWeight{color:var(--obc-text-muted);font-size:10px;font-weight:600}.K1gtda_awarenessRow{color:var(--obc-text-secondary);padding:4px 0;font-size:11px;line-height:1.55}.K1gtda_awarenessDate{color:var(--obc-text-muted);margin-right:6px}.K1gtda_probe{border:1px solid var(--obc-line);background:#ffffffd9;border-radius:12px;flex-direction:column;gap:4px;padding:10px 11px;display:flex}.K1gtda_probeDomain{color:var(--obc-text);font-size:12px;font-weight:800}.K1gtda_probeReason{color:var(--obc-text-secondary);font-size:11.5px;line-height:1.55}.K1gtda_probeActions{flex-wrap:wrap;gap:6px;margin-top:2px;display:flex}.K1gtda_drawerOverlay{z-index:10;backdrop-filter:blur(2px);background:#20304a47;flex-direction:column;justify-content:flex-start;display:flex;position:absolute;inset:0}.K1gtda_drawerPanel{background:radial-gradient(circle at 15% 4%, #fb729924, transparent 30%), var(--obc-bg);border-radius:18px 18px 0 0;flex-direction:column;flex:1;gap:10px;min-height:0;margin-top:8px;padding:14px 14px 24px;display:flex;overflow-y:auto}.K1gtda_drawerHeader{border-bottom:1px solid var(--obc-line);justify-content:space-between;align-items:center;padding-bottom:10px;display:flex}.K1gtda_drawerTitle{color:var(--obc-text);align-items:center;gap:6px;font-size:15px;font-weight:800;display:flex}.K1gtda_messageCard{background:var(--obc-surface-strong);border:1px solid var(--obc-line);border-radius:14px;flex-direction:column;gap:5px;padding:11px 12px;display:flex}.K1gtda_messageCard[data-tone=interest]{background:linear-gradient(135deg,#fff8e8,#fff0d5);border-color:#dd7f2d47}.K1gtda_messageCard[data-tone=avoidance]{background:linear-gradient(135deg,#eef7ff,#e1effc);border-color:#3b82f647}.K1gtda_messageCard[data-tone=challenge]{background:linear-gradient(135deg,#f7f2ff,#ede9fe);border-color:#7c3aed47}.K1gtda_messageCard[data-tone=delight]{background:linear-gradient(135deg,#fff5f8,#ffe9f0);border-color:#fb729952}.K1gtda_messageType{color:var(--obc-text-secondary);align-items:center;gap:5px;font-size:10.5px;font-weight:800;display:flex}.K1gtda_messageCard[data-tone=interest] .K1gtda_messageType{color:#c26a1d}.K1gtda_messageCard[data-tone=avoidance] .K1gtda_messageType{color:#2b6cc4}.K1gtda_messageCard[data-tone=challenge] .K1gtda_messageType{color:#7c3aed}.K1gtda_messageCard[data-tone=delight] .K1gtda_messageType{color:var(--obc-brand-strong)}.K1gtda_messagePrompt{color:var(--obc-text-secondary);font-size:10.5px;line-height:1.5}.K1gtda_messageTitle{color:var(--obc-text);font-size:13px;font-weight:800;line-height:1.45}.K1gtda_messageBody{color:#55657f;-webkit-line-clamp:4;-webkit-box-orient:vertical;font-size:11px;line-height:1.55;display:-webkit-box;overflow:hidden}.K1gtda_messageActions{flex-wrap:wrap;gap:6px;margin-top:2px;display:flex}.K1gtda_drawerEmpty{color:var(--obc-text-muted);flex-direction:column;align-items:center;gap:8px;padding:34px 20px;display:flex}.K1gtda_drawerEmptyTitle{font-size:13px;font-weight:700}.K1gtda_drawerEmptySubtitle{opacity:.75;font-size:11px}.K1gtda_recCard{background:linear-gradient(#fffffffa,#fafbfffa);border:1px solid #ebf0f8fa;border-radius:18px;flex-direction:column;gap:9px;padding:10px;transition:border-color .18s,box-shadow .18s;display:flex;box-shadow:inset 0 1px #ffffffd1}.K1gtda_recCard:hover{border-color:var(--obc-line-strong);box-shadow:0 18px 32px #fb729924}.K1gtda_recCover{aspect-ratio:16/9;cursor:pointer;width:100%;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb72991f,#5aa9ff1a),#f6f9fff0;border:0;border-radius:13px;justify-content:center;align-items:center;padding:0;font-size:12px;font-weight:700;line-height:1.5;display:flex;position:relative;overflow:hidden}.K1gtda_recCover img{object-fit:cover;width:100%;height:100%;display:block}.K1gtda_recCoverText{color:var(--obc-text);-webkit-line-clamp:4;-webkit-box-orient:vertical;padding:12px;font-size:12px;line-height:1.6;display:-webkit-box;overflow:hidden}.K1gtda_recCover .K1gtda_coverCorner{top:8px;left:8px}.K1gtda_recBody{flex-direction:column;gap:4px;padding:0 2px;display:flex}.K1gtda_recTitle{color:var(--obc-text);letter-spacing:-.01em;-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:15px;font-weight:800;line-height:1.38;display:-webkit-box;overflow:hidden}.K1gtda_delightRow{align-items:stretch;gap:10px;display:flex}.K1gtda_delightThumb{object-fit:cover;border-radius:12px;flex:none;align-self:center;width:96px;height:96px;box-shadow:inset 0 1px #ffffffb8}.K1gtda_delightThumbFallback{box-sizing:border-box;width:96px;height:96px;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb729924,#5aa9ff1f);border-radius:12px;flex:none;justify-content:center;align-self:center;align-items:center;padding:8px;font-size:10.5px;font-weight:700;line-height:1.5;display:flex;overflow:hidden}.K1gtda_delightCard{background:radial-gradient(circle at 100% 0,#fb729924,#0000 38%),linear-gradient(#fffcfefa,#f6fafffa);border:1px solid #fb729947;border-radius:18px;flex-shrink:0;grid-template-columns:minmax(0,1fr) 40px;gap:0;padding:0;transition:border-color .2s,box-shadow .2s;display:grid;overflow:hidden;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.K1gtda_delightRow{cursor:pointer;text-align:left;min-width:0;color:inherit;background:0 0;border:0;grid-area:1/1;align-items:center;gap:10px;padding:10px;display:flex}.K1gtda_delightThumb{aspect-ratio:16/9;object-fit:cover;background:linear-gradient(#fffffffa,#fff8fcf0),linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:12px;flex:none;width:104px;height:auto;transition:transform .2s,box-shadow .2s;box-shadow:inset 0 1px #ffffffb8,0 2px 8px #fb72991f}.K1gtda_delightCard:hover .K1gtda_delightThumb{transform:scale(1.02);box-shadow:inset 0 1px #ffffffb8,0 6px 14px #fb729938}.K1gtda_delightText{flex-direction:column;flex:1;gap:6px;min-width:0;display:flex}.K1gtda_delightKickerLine{flex-wrap:wrap;align-items:center;gap:5px;min-width:0;display:flex}.K1gtda_delightKicker{color:var(--obc-brand-strong);letter-spacing:.02em;text-overflow:ellipsis;white-space:nowrap;background:#fb72991a;border-radius:999px;max-width:100%;padding:2px 7px;font-size:9.5px;font-weight:700;overflow:hidden}.K1gtda_delightCounter{color:var(--obc-text-muted);white-space:nowrap;background:#0000000a;border-radius:8px;flex:none;padding:1px 6px;font-size:10px;font-weight:600}.K1gtda_delightNav:active:not(:disabled){transform:scale(.94)}.K1gtda_delightDismiss{color:var(--obc-text-muted);cursor:pointer;background:0 0;border:0;border-left:1px solid #eddbe999;grid-area:1/2;font-size:15px;line-height:1;transition:background .15s,color .15s}.K1gtda_delightBody{border-top:1px solid #eddbe999;flex-direction:column;grid-area:2/1/auto/-1;gap:8px;padding:4px 12px 12px;display:flex}.K1gtda_activityFooter{border:1px solid var(--obc-line);backdrop-filter:blur(18px);box-shadow:var(--obc-shadow-sm);background:#ffffffa8;border-radius:14px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.K1gtda_activityLine{color:var(--obc-text-secondary);font-size:11.5px;line-height:1.5}.K1gtda_footerItem{background:#fffc;border:1px solid #dfe7f3f5;border-radius:12px;flex-direction:column;gap:3px;padding:8px 10px;display:flex}.K1gtda_footerItemMeta{color:var(--obc-text-muted);flex-wrap:wrap;align-items:center;gap:7px;font-size:9.5px;font-weight:700;line-height:1.4;display:flex}.K1gtda_footerItemKind{min-height:18px;color:var(--obc-text-secondary);background:#fffffff5;border:1px solid #dfe7f3f5;border-radius:999px;align-items:center;padding:2px 7px;display:inline-flex}.K1gtda_footerItemSummary{color:var(--obc-text-secondary);word-break:break-word;font-size:11px;line-height:1.55}.K1gtda_pinnedFooter{border-top:1px solid var(--obc-line);backdrop-filter:blur(18px);background:#ffffff80;flex:none;padding:9px 14px 12px}.K1gtda_pinnedFooter .K1gtda_activityFooter{box-shadow:none;backdrop-filter:none;background:0 0;border:0;border-radius:0;gap:5px;margin:0;padding:6px 2px 2px}.K1gtda_expression{-webkit-line-clamp:unset;display:block;overflow:visible}.K1gtda_savedToggle{min-width:38px;min-height:26px;color:var(--obc-text-secondary);cursor:pointer;background:#f0f6ffe6;border:0;border-radius:11px;justify-content:center;align-items:center;transition:background .15s,color .15s,transform .15s;display:inline-flex}.K1gtda_savedToggle:hover:not(:disabled){color:var(--obc-text);transform:translateY(-1px)}.K1gtda_savedToggle:disabled{opacity:.6;cursor:wait}.K1gtda_savedToggle[data-pressed=true].K1gtda_watchToggle{color:var(--obc-brand-strong);background:var(--obc-brand-soft)}.K1gtda_savedToggle[data-pressed=true].K1gtda_starToggle{color:#e8a33d;background:#e8a33d1f}.K1gtda_savedToggle[data-pressed=true].K1gtda_starToggle svg{fill:currentColor}.K1gtda_feedbackStatus{color:var(--obc-brand-strong);min-height:15px;margin-top:2px;font-size:11px;line-height:1.5}.K1gtda_feedbackStatus[data-tone=success]{color:var(--obc-success)}.K1gtda_feedbackStatus[data-tone=error]{color:var(--obc-danger)}.K1gtda_commentComposer{flex-direction:column;gap:6px;margin-top:2px;display:flex}.K1gtda_commentComposer textarea{box-sizing:border-box;width:100%;color:var(--obc-text);resize:vertical;background:#ffffffe6;border:1px solid #e6edf8eb;border-radius:10px;padding:8px 9px;font-family:inherit;font-size:11.5px}.K1gtda_commentComposer textarea:focus{border-color:var(--obc-sky-blue);outline:none}.K1gtda_commentComposer .K1gtda_actionButton{align-self:flex-end}.K1gtda_activityFooter{background:linear-gradient(#fffffffa,#f2f6fdf5);border:1px solid #dfe7f3fa;border-radius:18px;flex-direction:column;gap:10px;margin:0;padding:12px 14px;display:flex;box-shadow:0 12px 24px #495d8214}.K1gtda_footerHead{justify-content:space-between;align-items:flex-start;gap:10px;display:flex}.K1gtda_footerCopy{flex-direction:column;flex:auto;gap:6px;min-width:0;display:flex}.K1gtda_footerHint{color:#41506b;min-height:18px;margin:0;padding-left:20px;font-size:12px;font-weight:700;line-height:1.6;position:relative}.K1gtda_footerHint:before{content:\"\";background:var(--obc-sky-blue);border-radius:999px;width:9px;height:9px;position:absolute;top:50%;left:0;transform:translateY(-50%);box-shadow:0 0 0 4px #5aa9ff1f}.K1gtda_footerHeadline{min-height:16px;color:var(--obc-text-muted);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:0;padding-left:20px;font-size:10.5px;font-weight:700;line-height:1.55;display:-webkit-box;position:relative;overflow:hidden}.K1gtda_footerHeadline:before{content:\"\";background:#fb72994d;border-radius:999px;width:9px;height:9px;position:absolute;top:50%;left:0;transform:translateY(-50%);box-shadow:0 0 0 4px #fb729914}.K1gtda_footerToggle{min-height:32px;color:var(--obc-text-secondary);cursor:pointer;background:#ffffffdb;border:0;border-radius:999px;flex-shrink:0;padding:7px 12px;font-size:11px;font-weight:800;line-height:1;box-shadow:0 8px 18px #495d8214}.K1gtda_footerToggle:hover{color:var(--obc-text)}.K1gtda_footerHistory{flex-direction:column;gap:8px;max-height:190px;display:flex;overflow-y:auto}.K1gtda_pendingItem{border-top:1px solid var(--obc-line);grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:10px;display:grid}.K1gtda_pendingCopy{gap:2px;min-width:0;display:grid}.K1gtda_pendingCopy strong{overflow-wrap:anywhere;color:var(--obc-text);font-size:12px;font-weight:800;line-height:1.45}.K1gtda_pendingKind,.K1gtda_pendingConfidence{color:var(--obc-text-secondary);font-size:10.5px;font-weight:700}.K1gtda_pendingOpen{cursor:pointer;border:1px solid var(--obc-line-strong);background:var(--obc-brand-soft);min-width:52px;min-height:34px;color:var(--obc-brand-strong);border-radius:999px;padding:6px 12px;font-size:11px;font-weight:800}.K1gtda_pendingOpen:hover:not(:disabled){background:#fb729933}.K1gtda_pendingOpen:disabled{opacity:.6;cursor:wait}.K1gtda_dialogueCard{box-sizing:border-box;overflow-wrap:anywhere;border:1px solid var(--obc-line-strong);background:var(--obc-surface-strong);width:100%;box-shadow:var(--obc-shadow-sm);border-radius:14px;flex-direction:column;gap:5px;padding:12px;display:flex}.K1gtda_dialogueCard[data-card-state=confirmed]{border-color:#30b9808c}.K1gtda_dialogueCard[data-card-state=rejected]{border-color:#ef7a8694}.K1gtda_dialogueCard[data-card-state=deferred]{border-color:#8f9bb09e}.K1gtda_dialogueKicker{color:var(--obc-brand-strong);letter-spacing:.06em;font-size:10.5px;font-weight:800}.K1gtda_dialogueTitle{color:var(--obc-text);font-size:13.5px;font-weight:700;line-height:1.55}.K1gtda_dialogueState{color:var(--obc-text-secondary);font-size:11.5px;font-weight:700}.K1gtda_dialogueEvidence{color:var(--obc-text-secondary);font-size:11.5px}.K1gtda_dialogueEvidence summary{cursor:pointer;width:fit-content;color:var(--obc-text-secondary);align-items:center;font-weight:700;display:flex}.K1gtda_dialogueEvidence ul{gap:5px;margin:3px 0 0 16px;line-height:1.55;display:grid}.K1gtda_dialogueActions{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin-top:6px;display:grid}.K1gtda_dialogueAction{cursor:pointer;border:1px solid var(--obc-line);background:var(--obc-surface);min-width:0;min-height:34px;color:var(--obc-text);border-radius:999px;padding:7px;font-size:12px;font-weight:800;transition:background .15s,transform .15s}.K1gtda_dialogueAction:hover:not(:disabled){transform:translateY(-1px)}.K1gtda_dialogueAction:disabled{cursor:default;opacity:.5}.K1gtda_dialogueAction.K1gtda_action_confirm{color:var(--obc-success)}.K1gtda_dialogueAction.K1gtda_action_reject{color:var(--obc-danger)}.K1gtda_dialogueAction.K1gtda_action_discuss{color:var(--obc-brand-strong)}.K1gtda_contextBar{border:1px solid var(--obc-line-strong);background:var(--obc-surface-soft);border-radius:12px;flex-direction:column;flex:none;gap:4px;min-width:0;padding:9px 11px;display:flex}.K1gtda_contextBarHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.K1gtda_contextLabel{letter-spacing:.04em;color:var(--obc-brand-strong);font-size:10px;font-weight:800}.K1gtda_contextTitle{color:var(--obc-text);overflow-wrap:anywhere;font-size:12.5px;font-weight:800;line-height:1.45}.K1gtda_contextObservation{color:var(--obc-text-secondary);-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:11px;line-height:1.55;display:-webkit-box;overflow:hidden}.K1gtda_contextInterpretation{color:#2b6cc4;font-size:10.5px;font-weight:600;line-height:1.5}.K1gtda_contextClear{color:var(--obc-text-secondary);cursor:pointer;background:#fffc;border:0;border-radius:999px;flex:none;padding:4px 10px;font-size:10.5px;font-weight:700}.K1gtda_contextClear:hover{color:var(--obc-text)}.K1gtda_replyQuote{border-left:3px solid var(--obc-brand);background:var(--obc-brand-soft);border-radius:8px;flex-direction:column;gap:1px;min-width:0;padding:6px 9px;display:flex}.K1gtda_replyQuote span{color:var(--obc-brand-strong);letter-spacing:.04em;font-size:9.5px;font-weight:800}.K1gtda_replyQuote strong{color:var(--obc-text-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:1.4;overflow:hidden}.K1gtda_viewIntro{padding:2px 4px 0}.K1gtda_viewKicker{letter-spacing:.08em;text-transform:uppercase;color:var(--obc-brand);font-size:9px;font-weight:700}.K1gtda_viewIntro h2{color:var(--obc-text);letter-spacing:-.02em;margin:2px 0 0;font-size:15px;font-weight:800;line-height:1.35}.K1gtda_viewIntro p{color:var(--obc-text-secondary);margin:3px 0 0;font-size:11px;line-height:1.6}.K1gtda_profileCard{flex-direction:column;gap:10px;display:flex}.K1gtda_profileSummary{background:#fcfafbf5;border:1px solid #e4dce8b3;border-radius:16px;padding:14px 16px}.K1gtda_profilePortraitP{color:var(--obc-text);text-indent:1.6em;margin:0;font-size:12.5px;line-height:1.85}.K1gtda_profilePortraitP:first-child{text-indent:0}.K1gtda_profileLayer{text-transform:uppercase;letter-spacing:.05em;color:var(--obc-text-muted);border-bottom:1px solid #e7eef899;margin-top:10px;margin-bottom:2px;padding:5px 0;font-size:9.5px;font-weight:700}.K1gtda_profileGroup{background:#fffffff0;border:1px solid #e7eef8f5;border-radius:16px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.K1gtda_profileGroup h3{color:var(--obc-text);margin:0;font-size:12px;font-weight:800;line-height:1.4}.K1gtda_profilePhaseCopy{color:var(--obc-text-secondary);margin:0;font-size:12px;line-height:1.7}.K1gtda_chip[data-tone=brand]{background:var(--obc-brand-soft);color:var(--obc-brand-strong)}.K1gtda_chip[data-tone=success]{color:var(--obc-success);background:#30b9801f}.K1gtda_chip[data-tone=danger]{color:var(--obc-danger);background:#ef7a861f}.K1gtda_chipWeight{opacity:.75;margin-left:3px;font-size:9px}.K1gtda_mbtiContainer{flex-direction:column;gap:8px;display:flex}.K1gtda_mbtiTypeRow{align-items:baseline;gap:8px;display:flex}.K1gtda_mbtiTypeLabel{color:var(--obc-brand-strong);letter-spacing:.02em;font-size:18px;font-weight:800}.K1gtda_mbtiConfidence{color:var(--obc-text-muted);background:#e7eef8f5;border-radius:999px;padding:2px 8px;font-size:9.5px;font-weight:600}.K1gtda_mbtiDimensions{flex-direction:column;gap:6px;display:flex}.K1gtda_mbtiDimRow{align-items:center;gap:8px;font-size:10.5px;display:flex}.K1gtda_mbtiDimPole{text-align:center;width:20px;color:var(--obc-brand-strong);font-weight:700}.K1gtda_mbtiDimBar{background:#e7eef8f5;border-radius:3px;flex:1;height:6px;overflow:hidden}.K1gtda_mbtiDimBarFill{background:linear-gradient(90deg,#f7828e,#c7698f);border-radius:3px;height:100%}.K1gtda_mbtiDimPct{text-align:right;width:32px;color:var(--obc-text-muted);font-size:9.5px}.K1gtda_interestTree{flex-direction:column;gap:8px;display:flex}.K1gtda_interestTreeLabel{font-size:11.5px;font-weight:700}.K1gtda_interestTreeLabel[data-tone=sky]{color:var(--obc-sky-blue)}.K1gtda_interestTreeLabel[data-tone=danger]{color:var(--obc-danger)}.K1gtda_interestDomain{flex-direction:column;gap:5px;display:flex}.K1gtda_interestDomainHeader{align-items:center;gap:6px;display:flex}.K1gtda_interestDomainName{color:var(--obc-text);font-size:12px;font-weight:800}.K1gtda_interestDomainWeight{color:var(--obc-text-muted);background:#e7eef8f5;border-radius:999px;padding:1px 7px;font-size:9.5px;font-weight:600}.K1gtda_barRow{align-items:center;gap:8px;font-size:11px;display:flex}.K1gtda_barLabel{min-width:64px;color:var(--obc-text-secondary)}.K1gtda_barTrack{background:#e7eef8f5;border-radius:3px;flex:1;height:6px;overflow:hidden}.K1gtda_barFill{background:linear-gradient(90deg,#397fcb,#5e9fd9);border-radius:3px;height:100%}.K1gtda_barPct{text-align:right;width:34px;color:var(--obc-text-muted);font-size:9.5px}.K1gtda_contextRow{gap:8px;font-size:11px;display:flex}.K1gtda_contextLabel{color:var(--obc-text-secondary);flex:none;min-width:44px}.K1gtda_contextValue{color:var(--obc-text)}.K1gtda_probe[data-tone=interest]{background:linear-gradient(135deg,#fff8e8,#fff0d5);border-color:#dd7f2d47}.K1gtda_probe[data-tone=avoidance]{background:linear-gradient(135deg,#eef7ff,#e1effc);border-color:#3b82f647}.K1gtda_probeHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.K1gtda_insightCard{border:1px solid var(--obc-line);background:#fffffff0;border-radius:14px;flex-direction:column;gap:7px;padding:12px 14px;display:flex}.K1gtda_insightCard[data-validated]{border-color:#30b98080}.K1gtda_insightHead{align-items:flex-start;gap:6px;display:flex}.K1gtda_insightTitle{color:var(--obc-text);flex:1;font-size:12px;font-weight:800;line-height:1.5}.K1gtda_insightValidated{color:var(--obc-success);background:#30b9801f;border-radius:999px;flex:none;padding:2px 7px;font-size:9.5px;font-weight:700}.K1gtda_insightConfidenceRow{align-items:center;gap:8px;display:flex}.K1gtda_insightConfidenceBar{background:#e7eef8f5;border-radius:3px;flex:1;height:6px;overflow:hidden}.K1gtda_insightConfidenceFill{background:linear-gradient(90deg,#f7828e,#c7698f);border-radius:3px;height:100%}.K1gtda_insightConfidenceLabel{color:var(--obc-text-muted);text-align:right;width:32px;font-size:9.5px}.K1gtda_insightEvidenceList{color:var(--obc-text-secondary);gap:4px;margin:0;padding-left:16px;font-size:11px;line-height:1.55;display:grid}.K1gtda_awarenessList{flex-direction:column;gap:8px;display:flex}.K1gtda_awarenessItem{background:#fffcf7f7;border:1px solid #f0e6d7e6;border-radius:14px;flex-direction:column;gap:4px;padding:10px 13px;display:flex}.K1gtda_awarenessHeader{align-items:center;gap:8px;display:flex}.K1gtda_awarenessItemDate{color:var(--obc-text-muted);white-space:nowrap;font-size:10px}.K1gtda_awarenessEmotion{color:var(--obc-brand);font-size:10px;font-weight:600}.K1gtda_awarenessObservation{color:var(--obc-text);font-size:11.5px;line-height:1.65}.K1gtda_awarenessTrend{color:var(--obc-text-secondary);border-left:2px solid #fb729940;padding-left:8px;font-size:11px;line-height:1.5}.K1gtda_questionCard{box-sizing:border-box;width:100%;box-shadow:var(--obc-shadow-sm);background:linear-gradient(135deg,#eef7ff,#e1effc);border:1px solid #3b82f647;border-radius:14px;flex-direction:column;gap:6px;padding:12px;display:flex}.K1gtda_pendingObservation{color:var(--obc-text-secondary);font-size:11px;line-height:1.55}.K1gtda_pendingInterpretation{color:var(--obc-sky-blue);font-size:10.5px;font-weight:600;line-height:1.5}.K1gtda_questionObservation{color:var(--obc-text);background:#ffffffb3;border-radius:8px;padding:6px 9px;font-size:11.5px;line-height:1.6}.K1gtda_questionInterpretation{color:#2b6cc4;font-size:11px;font-weight:600;line-height:1.55}.K1gtda_delightCard{background:radial-gradient(circle at 100% 0,#fb729924,#0000 38%),linear-gradient(#fffcfefa,#f6fafffa);border:1px solid #fb729938;border-radius:16px;flex-direction:column;grid-template-columns:none;gap:0;padding:0;transition:border-color .2s,box-shadow .2s;display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.K1gtda_delightKicker{color:var(--obc-brand-strong);letter-spacing:.02em;white-space:nowrap;background:#fb72991a;border-radius:999px;padding:2px 7px;font-size:9.5px;font-weight:700}.K1gtda_delightPlatform{color:var(--obc-text-muted);white-space:nowrap;background:#0000000d;border-radius:999px;flex:none;padding:2px 6px;font-size:9.5px;font-weight:600}.K1gtda_delightCounter{color:var(--obc-text-muted);white-space:nowrap;flex:none;font-size:10px;font-weight:600}.K1gtda_delightNav{width:26px;height:26px;color:var(--obc-brand-strong);cursor:pointer;background:#fffc;border:1px solid #fb729938;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;font-size:14px;font-weight:700;line-height:1;transition:background .15s,border-color .15s;display:inline-flex}.K1gtda_delightNav:hover:not(:disabled){background:#fb729924;border-color:#fb729973}.K1gtda_delightNav:disabled{opacity:.32;cursor:default}.K1gtda_delightDismiss{width:26px;height:26px;color:var(--obc-text-secondary);cursor:pointer;background:#0000000a;border:0;border-left-width:medium;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;font-size:15px;line-height:1;transition:background .15s,color .15s;display:inline-flex}.K1gtda_delightRow{cursor:pointer;text-align:left;min-width:0;color:inherit;background:0 0;border:0;align-items:center;gap:10px;padding:8px 10px 10px;display:flex}.K1gtda_delightThumb{aspect-ratio:auto;object-fit:cover;background:linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:10px;flex:none;width:104px;height:58px;box-shadow:inset 0 1px #ffffffb8,0 2px 8px #fb72991f}.K1gtda_delightThumbFallback{aspect-ratio:auto;box-sizing:border-box;width:104px;height:58px;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:10px;flex:none;justify-content:center;align-items:center;padding:4px;font-size:9px;font-weight:700;line-height:1.4;display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffffb8}.K1gtda_delightText{flex:1;align-items:center;min-width:0;display:flex}.K1gtda_delightTitle{min-width:0;color:var(--obc-text);-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;font-size:12.5px;font-weight:700;line-height:1.55;display:-webkit-box;overflow:hidden}.K1gtda_delightChevron{width:24px;height:24px;color:var(--obc-text-muted);cursor:pointer;background:#ffffffb3;border:0;border-radius:50%;flex:none;justify-content:center;align-items:center;font-size:10px;line-height:1;display:inline-flex}.K1gtda_delightCard{background:radial-gradient(circle at 100% 0,#fb729924,#0000 38%),linear-gradient(#fffcfefa,#f6fafffa);border:1px solid #fb729947;border-radius:18px;flex-direction:column;flex-shrink:0;gap:0;padding:0;transition:border-color .2s,box-shadow .2s;display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffffd1,0 4px 14px #fb72991a}.K1gtda_delightCard:hover{border-color:#fb729980;box-shadow:inset 0 1px #ffffffd1,0 12px 28px #fb72992e}.K1gtda_delightHeader{align-items:center;gap:7px;min-width:0;padding:10px 12px 2px;display:flex}.K1gtda_delightMain{cursor:pointer;text-align:left;min-width:0;color:inherit;background:0 0;border:0;flex-direction:column;gap:8px;padding:4px 10px 10px;display:flex}.K1gtda_delightCover{aspect-ratio:16/9;background:linear-gradient(#fffffffa,#fff8fcf0),linear-gradient(145deg,#fb72992e,#a855f71f);border:1px solid #ffffffeb;border-radius:14px;width:100%;transition:box-shadow .2s;display:block;position:relative;overflow:hidden;box-shadow:inset 0 1px #ffffffb8,0 2px 8px #fb72991f}.K1gtda_delightCard:hover .K1gtda_delightCover{box-shadow:inset 0 1px #ffffffb8,0 8px 18px #fb729938}.K1gtda_delightHero{object-fit:cover;width:100%;height:100%;transition:transform .35s;display:block}.K1gtda_delightCard:hover .K1gtda_delightHero{transform:scale(1.03)}.K1gtda_delightCover:before{content:\"✨\";width:27px;height:27px;color:var(--obc-brand-strong);text-align:center;pointer-events:none;z-index:2;background:#fffffff0;border-radius:999px;font-size:15px;line-height:27px;position:absolute;top:8px;left:8px;box-shadow:0 2px 8px #fb72994d}.K1gtda_delightCoverScrim{pointer-events:none;z-index:1;background:linear-gradient(#0000,#141a2870);height:40%;position:absolute;inset:auto 0 0}.K1gtda_delightScorePill{z-index:2;color:#fff;letter-spacing:.01em;background:linear-gradient(135deg,#fb7299f5,#e25885e6);border-radius:999px;padding:3px 10px;font-size:10.5px;font-weight:800;line-height:1.4;position:absolute;bottom:8px;left:8px;box-shadow:0 2px 8px #fb72995c}.K1gtda_delightHeroFallback{box-sizing:border-box;width:100%;height:100%;min-height:96px;color:var(--obc-text-secondary);text-align:center;background:linear-gradient(145deg,#fb729924,#5aa9ff1a);justify-content:center;align-items:center;padding:12px 14px;font-size:11px;font-weight:700;line-height:1.55;display:flex;overflow:hidden}.K1gtda_delightCover:has(.K1gtda_delightHeroFallback){aspect-ratio:auto}.K1gtda_delightTitleWrap{align-items:center;gap:8px;min-width:0;padding:0 2px;display:flex}.K1gtda_delightTitle{min-width:0;color:var(--obc-text);-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;flex:1;font-size:13px;font-weight:800;line-height:1.5;display:-webkit-box;overflow:hidden}.K1gtda_delightCard[data-expanded=true] .K1gtda_delightTitle{-webkit-line-clamp:unset;display:block}.K1gtda_delightChevron{width:24px;height:24px;color:var(--obc-text-muted);background:#ffffffb3;border:0;border-radius:8px;flex:none;justify-content:center;align-items:center;font-size:10px;line-height:1;display:inline-flex}.K1gtda_delightDismiss{color:var(--obc-text-muted);cursor:pointer;background:0 0;border:0;border-left:1px solid #eddbe999;border-radius:0 8px 8px 0;padding:3px 7px;font-size:15px;line-height:1;transition:background .15s,color .15s}.K1gtda_delightDismiss:hover:not(:disabled){color:var(--obc-danger);background:#ef7a861f}.K1gtda_delightDismiss:disabled{cursor:wait;opacity:.58}.K1gtda_delightBody{border-top:1px solid #eddbe999;flex-direction:column;gap:8px;padding:2px 12px 12px;display:flex}.K1gtda_delightBody .K1gtda_delightReason{margin-top:8px}.K1gtda_delightReason{color:var(--obc-text-secondary);background:#f0f6ffe6;border-radius:10px;padding:8px 10px;font-size:11.5px;line-height:1.6}.K1gtda_delightScore{color:var(--obc-brand-strong);font-weight:800}.K1gtda_delightActions{flex-wrap:wrap;gap:6px;display:flex}.K1gtda_delightActions .K1gtda_actionButton{flex:1;min-width:0;padding:6px 8px;font-size:11.5px}.K1gtda_delightComposer{align-items:flex-end;gap:6px;display:flex}.K1gtda_delightComposer .K1gtda_chatInput{flex:1}.K1gtda_settingsOverlay{z-index:12;backdrop-filter:blur(2px);background:#20304a47;flex-direction:column;justify-content:flex-start;display:flex;position:absolute;inset:0}.K1gtda_settingsPanel{background:radial-gradient(circle at 15% 4%, #fb72991f, transparent 30%), var(--obc-bg);border-radius:18px 18px 0 0;flex-direction:column;flex:1;min-height:0;margin-top:8px;display:flex}.K1gtda_settingsHeader{border-bottom:1px solid var(--obc-line);flex:none;justify-content:space-between;align-items:center;padding:14px 14px 10px;display:flex}.K1gtda_settingsHeader h2{color:var(--obc-text);letter-spacing:-.02em;margin:0;font-size:15px;font-weight:800}.K1gtda_settingsBack{width:30px;height:30px;color:var(--obc-text-secondary);cursor:pointer;background:#ffffffc2;border:1px solid #e6edf8eb;border-radius:10px;font-size:14px}.K1gtda_settingsBack:hover{background:var(--obc-brand-soft);color:var(--obc-brand-strong)}.K1gtda_settingsTabs{border-bottom:1px solid var(--obc-line);scrollbar-width:none;flex:none;gap:2px;padding:8px 10px 0;display:flex;overflow-x:auto}.K1gtda_settingsTab{color:var(--obc-text-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:0;border-radius:8px 8px 0 0;padding:6px 10px 8px;font-size:11.5px;font-weight:700}.K1gtda_settingsTab:hover{color:var(--obc-text);background:var(--obc-interactive-bg-hover,#ffffff80)}.K1gtda_settingsTab[data-active=true]{color:var(--obc-brand-strong);box-shadow:inset 0 -2px 0 var(--obc-brand);font-weight:800}.K1gtda_settingsBody{flex-direction:column;flex:1;gap:10px;min-height:0;padding:12px 14px 24px;display:flex;overflow-y:auto}.K1gtda_settingsToastBar{color:var(--obc-success);background:#30b9801f;border:1px solid #30b9804d;border-radius:8px;flex:none;padding:7px 10px;font-size:11.5px}.K1gtda_settingsSection{background:#fffffff0;border:1px solid #e7eef8f5;border-radius:16px;flex-direction:column;gap:10px;padding:12px 14px;display:flex}.K1gtda_settingsSection h3{color:var(--obc-text);align-items:center;gap:6px;margin:0;font-size:13px;font-weight:800;display:flex}.K1gtda_sectionIcon{font-size:14px}.K1gtda_settingsField{flex-direction:column;gap:4px;display:flex}.K1gtda_settingsField>label{color:var(--obc-text-secondary);font-size:11px;font-weight:700}.K1gtda_settingsFieldRow{color:var(--obc-text);align-items:center;gap:8px;font-size:11.5px;display:flex}.K1gtda_settingsFieldRow input[type=checkbox]{accent-color:var(--obc-brand)}.K1gtda_settingsInput{box-sizing:border-box;width:100%;color:var(--obc-text);background:#ffffffe6;border:1px solid #e6edf8eb;border-radius:8px;padding:6px 9px;font-family:inherit;font-size:11.5px}.K1gtda_settingsInput:focus{border-color:var(--obc-sky-blue);outline:none}.K1gtda_settingsHint{color:var(--obc-text-muted);margin:0;font-size:10.5px;line-height:1.5}.K1gtda_settingsActions{align-items:center;gap:8px;display:flex}.K1gtda_settingsToast{color:var(--obc-success);font-size:11px}.K1gtda_settingsInstance{border:1px solid var(--obc-line);background:#ffffffb3;border-radius:12px;flex-direction:column;gap:8px;padding:10px 11px;display:flex}.K1gtda_settingsInstanceHead{color:var(--obc-text);justify-content:space-between;align-items:center;gap:8px;font-size:12px;font-weight:800;display:flex}.K1gtda_settingsSavebar{border:1px solid var(--obc-line);backdrop-filter:blur(14px);box-shadow:var(--obc-shadow-sm);background:#ffffffd1;border-radius:14px;justify-content:flex-end;align-items:center;gap:10px;margin-top:12px;padding:10px 12px;display:flex;position:sticky;bottom:0}.K1gtda_settingsSavebarMsg{color:var(--obc-text-muted);flex:1;font-size:11px}.K1gtda_probeStatus{color:var(--obc-text-muted);word-break:break-word;font-size:11px;line-height:1.5}.K1gtda_probeStatus[data-tone=success]{color:var(--obc-success)}.K1gtda_probeStatus[data-tone=error]{color:var(--obc-danger)}.K1gtda_llmInstanceList{flex-direction:column;gap:8px;display:flex}.K1gtda_llmInstance{border:1px solid var(--obc-line);background:#ffffffb3;border-radius:12px;justify-content:space-between;align-items:center;gap:10px;padding:9px 11px;display:flex}.K1gtda_llmInstanceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.K1gtda_llmInstanceHead{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.K1gtda_llmInstanceName{color:var(--obc-text);font-size:12px;font-weight:800}.K1gtda_llmBadge{background:var(--obc-brand-soft);color:var(--obc-brand-strong);border-radius:999px;padding:3px 7px;font-size:9px;font-weight:800;line-height:1}.K1gtda_llmBadge[data-tone=off]{color:var(--obc-text-muted);background:#8290a829}.K1gtda_llmInstanceDetail{color:var(--obc-text-muted);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.K1gtda_llmInstanceActions{flex:none;gap:6px;display:flex}.K1gtda_chainSection{border-top:1px dashed var(--obc-line);flex-direction:column;gap:8px;margin-top:10px;padding-top:10px;display:flex}.K1gtda_chainHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.K1gtda_chainHead h4{color:var(--obc-text);margin:0;font-size:11.5px;font-weight:800}.K1gtda_chainEditor{flex-direction:column;gap:6px;display:flex}.K1gtda_chainList{flex-direction:column;gap:4px;display:flex}.K1gtda_chainRow{border:1px solid var(--obc-line);background:#ffffff9e;border-radius:10px;align-items:center;gap:4px;padding:5px 8px;display:flex}.K1gtda_chainName{min-width:0;color:var(--obc-text);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:11px;font-weight:700;overflow:hidden}.K1gtda_chainBtn{border:1px solid var(--obc-line);width:22px;height:22px;color:var(--obc-text-muted);cursor:pointer;background:#ffffffb3;border-radius:7px;flex:none;justify-content:center;align-items:center;font-size:10px;line-height:1;display:inline-flex}.K1gtda_chainBtn:hover:not(:disabled){color:var(--obc-brand-strong);border-color:var(--obc-brand)}.K1gtda_chainBtn:disabled{opacity:.35;cursor:default}.K1gtda_chainPicker{align-items:center;gap:6px;display:flex}.K1gtda_chainPicker .K1gtda_settingsInput{flex:1;min-width:0}.K1gtda_moduleRoute{border:1px solid var(--obc-line);background:#ffffff9e;border-radius:12px;margin-bottom:8px;padding:8px 10px}.K1gtda_dialogOverlay{backdrop-filter:blur(3px);z-index:60;background:#141a286b;justify-content:center;align-items:flex-start;padding:6vh 14px;display:flex;position:fixed;inset:0}.K1gtda_dialogCard{border:1px solid var(--obc-line);background:var(--obc-bg);width:min(460px,100%);max-height:86vh;box-shadow:var(--obc-shadow-lg);border-radius:16px;flex-direction:column;gap:10px;padding:14px;display:flex;overflow-y:auto}.K1gtda_dialogHead{justify-content:space-between;align-items:center;gap:8px;display:flex}.K1gtda_dialogHead h3{color:var(--obc-text);margin:0;font-size:13px;font-weight:800}.K1gtda_dialogFields{flex-direction:column;gap:8px;display:flex}.K1gtda_dialogActionRow{align-items:center;gap:6px;display:flex}.K1gtda_dialogActionRow .K1gtda_settingsInput{flex:1;min-width:0}.K1gtda_dialogActions{border-top:1px solid var(--obc-line);flex-wrap:wrap;align-items:center;gap:8px;padding-top:10px;display:flex}.K1gtda_dialogActions .K1gtda_probeStatus{flex:100%;order:-1}.K1gtda_updateRow{color:var(--obc-text-secondary);justify-content:space-between;align-items:baseline;gap:10px;padding:4px 0;font-size:11.5px;display:flex}.K1gtda_updateRow strong{color:var(--obc-text);word-break:break-word;text-align:right;font-weight:800}.K1gtda_panel[data-dark=true]{--obc-bg:#15161a;--obc-sky:#0f1115;--obc-surface:#24262ce0;--obc-surface-strong:#282a31f7;--obc-surface-soft:#212329d1;--obc-line:#ffffff14;--obc-line-strong:#fb729959;--obc-text:#e9ebf1;--obc-text-secondary:#b0b9ca;--obc-text-muted:#8c97ad;--obc-brand-soft:#fb729929;--obc-sky-soft:#5aa9ff29;--obc-shadow-lg:0 20px 40px #00000073;--obc-shadow-sm:0 10px 22px #00000059;background:radial-gradient(circle at 15% 8%,#fb72991a,#0000 30%),radial-gradient(circle at 88% 12%,#5aa9ff1a,#0000 26%),linear-gradient(#17181d 0%,#101216 100%)}.K1gtda_panel[data-dark=true] .K1gtda_iconButton,.K1gtda_panel[data-dark=true] .K1gtda_settingsBack{color:var(--obc-text-secondary);background:#ffffff0f;border-color:#ffffff1a}.K1gtda_panel[data-dark=true] .K1gtda_iconButton:hover,.K1gtda_panel[data-dark=true] .K1gtda_settingsBack:hover{background:var(--obc-brand-soft);color:var(--obc-brand-strong)}.K1gtda_panel[data-dark=true] .K1gtda_tab:hover{background:#ffffff0f}.K1gtda_panel[data-dark=true] .K1gtda_tab[data-active=true]{background:linear-gradient(#ffffff1a,#fb729924);box-shadow:0 10px 18px #0000004d}.K1gtda_panel[data-dark=true] .K1gtda_recHeader,.K1gtda_panel[data-dark=true] .K1gtda_card,.K1gtda_panel[data-dark=true] .K1gtda_recCard,.K1gtda_panel[data-dark=true] .K1gtda_profileGroup,.K1gtda_panel[data-dark=true] .K1gtda_settingsSection,.K1gtda_panel[data-dark=true] .K1gtda_dialogueCard,.K1gtda_panel[data-dark=true] .K1gtda_insightCard,.K1gtda_panel[data-dark=true] .K1gtda_probe,.K1gtda_panel[data-dark=true] .K1gtda_footerItem{box-shadow:none;background:linear-gradient(#26282feb,#21232aeb);border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_card:hover,.K1gtda_panel[data-dark=true] .K1gtda_recCard:hover{border-color:#fb729973;box-shadow:0 14px 26px #0006}.K1gtda_panel[data-dark=true] .K1gtda_delightCard{background:radial-gradient(circle at 100% 0,#fb72991f,#0000 38%),linear-gradient(#2c242cf7,#1e222cf7);border-color:#fb72994d;box-shadow:inset 0 1px #ffffff0d,0 4px 14px #0000004d}.K1gtda_panel[data-dark=true] .K1gtda_delightCard:hover{border-color:#fb72998c;box-shadow:inset 0 1px #ffffff0d,0 12px 28px #0006}.K1gtda_panel[data-dark=true] .K1gtda_delightKicker,.K1gtda_panel[data-dark=true] .K1gtda_topicBadge,.K1gtda_panel[data-dark=true] .K1gtda_chip[data-tone=brand]{background:#fb729929}.K1gtda_panel[data-dark=true] .K1gtda_delightPlatform,.K1gtda_panel[data-dark=true] .K1gtda_stateBadge,.K1gtda_panel[data-dark=true] .K1gtda_platformTag,.K1gtda_panel[data-dark=true] .K1gtda_poolChip,.K1gtda_panel[data-dark=true] .K1gtda_chip,.K1gtda_panel[data-dark=true] .K1gtda_contextBadge{color:var(--obc-text-secondary);background:#ffffff12}.K1gtda_panel[data-dark=true] .K1gtda_delightNav,.K1gtda_panel[data-dark=true] .K1gtda_delightChevron,.K1gtda_panel[data-dark=true] .K1gtda_footerToggle,.K1gtda_panel[data-dark=true] .K1gtda_pendingOpen,.K1gtda_panel[data-dark=true] .K1gtda_contextClear{background:#ffffff12}.K1gtda_panel[data-dark=true] .K1gtda_actionButton{color:var(--obc-text-secondary);background:#ffffff12}.K1gtda_panel[data-dark=true] .K1gtda_actionButton:hover:not(:disabled){color:var(--obc-text);background:#ffffff1f}.K1gtda_panel[data-dark=true] .K1gtda_savedToggle{color:var(--obc-text-secondary);background:#ffffff12}.K1gtda_panel[data-dark=true] .K1gtda_settingsInput,.K1gtda_panel[data-dark=true] .K1gtda_commentInput,.K1gtda_panel[data-dark=true] .K1gtda_chatInput,.K1gtda_panel[data-dark=true] .K1gtda_commentComposer textarea{color:var(--obc-text);background:#181a1fe6;border-color:#ffffff1a}.K1gtda_panel[data-dark=true] .K1gtda_turnSoul,.K1gtda_panel[data-dark=true] .K1gtda_questionObservation{background:#ffffff0f;border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_turnUser{background:#fb729933}.K1gtda_panel[data-dark=true] .K1gtda_profileSummary{background:#242028f0;border-color:#ffffff12}.K1gtda_panel[data-dark=true] .K1gtda_awarenessItem{background:#28241ef0;border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_questionCard{background:linear-gradient(135deg,#1a2433,#141d2c);border-color:#3b82f659}.K1gtda_panel[data-dark=true] .K1gtda_messageCard[data-tone=interest]{background:linear-gradient(135deg,#2b2418,#241d12);border-color:#dd7f2d66}.K1gtda_panel[data-dark=true] .K1gtda_messageCard[data-tone=avoidance]{background:linear-gradient(135deg,#141f2e,#101a26);border-color:#3b82f666}.K1gtda_panel[data-dark=true] .K1gtda_messageCard[data-tone=challenge]{background:linear-gradient(135deg,#221d33,#1b1728);border-color:#7c3aed66}.K1gtda_panel[data-dark=true] .K1gtda_messageCard[data-tone=delight]{background:linear-gradient(135deg,#2e1f26,#261a20);border-color:#fb729966}.K1gtda_panel[data-dark=true] .K1gtda_probe[data-tone=interest]{background:linear-gradient(135deg,#2b2418,#241d12);border-color:#dd7f2d66}.K1gtda_panel[data-dark=true] .K1gtda_probe[data-tone=avoidance]{background:linear-gradient(135deg,#141f2e,#101a26);border-color:#3b82f666}.K1gtda_panel[data-dark=true] .K1gtda_messageBody{color:#b4bece}.K1gtda_panel[data-dark=true] .K1gtda_mbtiDimBar,.K1gtda_panel[data-dark=true] .K1gtda_barTrack,.K1gtda_panel[data-dark=true] .K1gtda_insightConfidenceBar,.K1gtda_panel[data-dark=true] .K1gtda_mbtiConfidence{background:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_drawerPanel,.K1gtda_panel[data-dark=true] .K1gtda_settingsPanel{background:radial-gradient(circle at 15% 4%,#fb729914,#0000 30%),#15161a}.K1gtda_panel[data-dark=true] .K1gtda_settingsInstance{background:#ffffff0a;border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_pendingItem{border-top-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_contextBar,.K1gtda_panel[data-dark=true] .K1gtda_activityFooter{background:#212329d9;border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_subTabs{background:#ffffff0a;border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_subTab[data-active=true]{background:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_delightReason{color:var(--obc-text-secondary);background:#ffffff0f}.K1gtda_panel[data-dark=true] .K1gtda_delightBody{border-top-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_delightChevron{color:var(--obc-text-secondary);background:#ffffff12}.K1gtda_panel[data-dark=true] .K1gtda_delightDismiss{border-left-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_footerHint{color:#c3cddd}.K1gtda_panel[data-dark=true] .K1gtda_settingsSavebar,.K1gtda_panel[data-dark=true] .K1gtda_llmInstance,.K1gtda_panel[data-dark=true] .K1gtda_chainRow,.K1gtda_panel[data-dark=true] .K1gtda_moduleRoute{background:#24262ce0;border-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_chainBtn{background:#ffffff0f;border-color:#ffffff1a}.K1gtda_panel[data-dark=true] .K1gtda_dialogCard{background:radial-gradient(circle at 15% 4%,#fb729914,#0000 30%),#15161a;border-color:#ffffff1a}.K1gtda_panel[data-dark=true] .K1gtda_llmBadge{background:#fb729933}.K1gtda_panel[data-dark=true] .K1gtda_actionButton:disabled{opacity:.66;color:#9aa4b8}.K1gtda_panel[data-dark=true] .K1gtda_recCover{background:linear-gradient(145deg,#fb729924,#5aa9ff1f),#1e2028f5}.K1gtda_panel[data-dark=true] .K1gtda_delightCover{background:linear-gradient(#282a31f5,#212329f5),linear-gradient(145deg,#fb729929,#5aa9ff1a);border-color:#ffffff24;box-shadow:inset 0 1px #ffffff0f,0 2px 8px #0000004d}.K1gtda_panel[data-dark=true] .K1gtda_delightCard:hover .K1gtda_delightCover{box-shadow:inset 0 1px #ffffff0f,0 8px 18px #0000006b}.K1gtda_panel[data-dark=true] .K1gtda_delightHeroFallback{color:var(--obc-text);background:linear-gradient(145deg,#fb729929,#5aa9ff1f)}.K1gtda_panel[data-dark=true] .K1gtda_pinnedFooter{background:#15161ab3;border-top-color:#ffffff14}.K1gtda_panel[data-dark=true] .K1gtda_pinnedFooter .K1gtda_activityFooter{box-shadow:none;background:0 0;border:0}.K1gtda_panel[data-dark=true] .K1gtda_starButton{background:linear-gradient(#2c242cf7,#fb72991f);border-color:#fb729952}.K1gtda_sidebarButton{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary,#20304a);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:13px;font-weight:600;line-height:22px;display:flex;overflow:hidden}.K1gtda_sidebarButton:hover{background:var(--dsw-alias-interactive-bg-hover,#0000000d)}.K1gtda_sidebarButton[data-active=true]{color:#f65788;background:#fb72991f}.K1gtda_sidebarButton[data-wide=false]{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.K1gtda_sidebarButtonIcon{object-fit:cover;background:linear-gradient(135deg,#fb7299,#ff8cb0);border-radius:6px;flex:none;width:18px;height:18px;display:block;box-shadow:0 4px 8px #fb729940}.K1gtda_sidebarButtonLabel{white-space:nowrap;overflow:hidden}.obc-panel-handle:after{content:\"\";background:#20304a2e;border-radius:2px;width:2px;height:32px;transition:background .15s;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.obc-panel-handle:hover:after{background:#fb72998c}";
		...
		var panel_module_css_default = {
			"turn": "K1gtda_turn",
			"sidebarButton": "K1gtda_sidebarButton",
			"coverWrap": "K1gtda_coverWrap",
			"probeConfidence": "K1gtda_probeConfidence",
			"footerItemSummary": "K1gtda_footerItemSummary",
			"messageCard": "K1gtda_messageCard",
			"llmInstanceHead": "K1gtda_llmInstanceHead",
			"dialogueEvidence": "K1gtda_dialogueEvidence",
			"mbtiConfidence": "K1gtda_mbtiConfidence",
			"cardTitle": "K1gtda_cardTitle",
			"settingsSavebarMsg": "K1gtda_settingsSavebarMsg",
			"status": "K1gtda_status",
			"footerHead": "K1gtda_footerHead",
			"contextInterpretation": "K1gtda_contextInterpretation",
			"awarenessObservation": "K1gtda_awarenessObservation",
			"delightHeroFallback": "K1gtda_delightHeroFallback",
			"insightNote": "K1gtda_insightNote",
			"portrait": "K1gtda_portrait",
			"probeActions": "K1gtda_probeActions",
			"replyQuote": "K1gtda_replyQuote",
			"mbtiTypeRow": "K1gtda_mbtiTypeRow",
			"hint": "K1gtda_hint",
			"footerHistory": "K1gtda_footerHistory",
			"viewIntro": "K1gtda_viewIntro",
			"action_discuss": "K1gtda_action_discuss",
			"chainBtn": "K1gtda_chainBtn",
			"mbtiDimensions": "K1gtda_mbtiDimensions",
			"profileLayer": "K1gtda_profileLayer",
			"poolChips": "K1gtda_poolChips",
			"profilePhaseCopy": "K1gtda_profilePhaseCopy",
			"insightConfidenceFill": "K1gtda_insightConfidenceFill",
			"delightChevron": "K1gtda_delightChevron",
			"settingsBody": "K1gtda_settingsBody",
			"contextBadge": "K1gtda_contextBadge",
			"tabBar": "K1gtda_tabBar",
			"confirmPanel": "K1gtda_confirmPanel",
			"brand": "K1gtda_brand",
			"delightBody": "K1gtda_delightBody",
			"contextBarHead": "K1gtda_contextBarHead",
			"mbtiContainer": "K1gtda_mbtiContainer",
			"recKicker": "K1gtda_recKicker",
			"footerCopy": "K1gtda_footerCopy",
			"insightCard": "K1gtda_insightCard",
			"delightCover": "K1gtda_delightCover",
			"delightCoverScrim": "K1gtda_delightCoverScrim",
			"delightTitleWrap": "K1gtda_delightTitleWrap",
			"sidebarButtonIcon": "K1gtda_sidebarButtonIcon",
			"mbtiTypeLabel": "K1gtda_mbtiTypeLabel",
			"turnStatus": "K1gtda_turnStatus",
			"chipWeight": "K1gtda_chipWeight",
			"delightDismiss": "K1gtda_delightDismiss",
			"interestDomainHeader": "K1gtda_interestDomainHeader",
			"mbtiDimBar": "K1gtda_mbtiDimBar",
			"confirmItem": "K1gtda_confirmItem",
			"footerItemKind": "K1gtda_footerItemKind",
			"confirmTitle": "K1gtda_confirmTitle",
			"commentRow": "K1gtda_commentRow",
			"messagePrompt": "K1gtda_messagePrompt",
			"chatSend": "K1gtda_chatSend",
			"footerItemMeta": "K1gtda_footerItemMeta",
			"commentComposer": "K1gtda_commentComposer",
			"dialogueCard": "K1gtda_dialogueCard",
			"profileGroup": "K1gtda_profileGroup",
			"chainList": "K1gtda_chainList",
			"contextTitle": "K1gtda_contextTitle",
			"chainPicker": "K1gtda_chainPicker",
			"settingsInput": "K1gtda_settingsInput",
			"pendingCopy": "K1gtda_pendingCopy",
			"brandMark": "K1gtda_brandMark",
			"barPct": "K1gtda_barPct",
			"probeReason": "K1gtda_probeReason",
			"awarenessEmotion": "K1gtda_awarenessEmotion",
			"interestDomainHead": "K1gtda_interestDomainHead",
			"barFill": "K1gtda_barFill",
			"settingsTabs": "K1gtda_settingsTabs",
			"panel": "K1gtda_panel",
			"chatInputRow": "K1gtda_chatInputRow",
			"delightKicker": "K1gtda_delightKicker",
			"interestDomainName": "K1gtda_interestDomainName",
			"settingsSection": "K1gtda_settingsSection",
			"messageType": "K1gtda_messageType",
			"subTabs": "K1gtda_subTabs",
			"action_confirm": "K1gtda_action_confirm",
			"coverCorner": "K1gtda_coverCorner",
			"awarenessTrend": "K1gtda_awarenessTrend",
			"llmInstanceActions": "K1gtda_llmInstanceActions",
			"settingsField": "K1gtda_settingsField",
			"messageBody": "K1gtda_messageBody",
			"dialogueActions": "K1gtda_dialogueActions",
			"interestTreeLabel": "K1gtda_interestTreeLabel",
			"llmInstanceDetail": "K1gtda_llmInstanceDetail",
			"chainRow": "K1gtda_chainRow",
			"recHeaderTitle": "K1gtda_recHeaderTitle",
			"insightConfidenceRow": "K1gtda_insightConfidenceRow",
			"insightEvidenceList": "K1gtda_insightEvidenceList",
			"barLabel": "K1gtda_barLabel",
			"footerHeadline": "K1gtda_footerHeadline",
			"insightConfidenceBar": "K1gtda_insightConfidenceBar",
			"delightMain": "K1gtda_delightMain",
			"confirmCount": "K1gtda_confirmCount",
			"delightRow": "K1gtda_delightRow",
			"delightThumb": "K1gtda_delightThumb",
			"contextClear": "K1gtda_contextClear",
			"settingsToast": "K1gtda_settingsToast",
			"insightValidated": "K1gtda_insightValidated",
			"activityRow": "K1gtda_activityRow",
			"delightScore": "K1gtda_delightScore",
			"delightCounter": "K1gtda_delightCounter",
			"brandCopy": "K1gtda_brandCopy",
			"insightHead": "K1gtda_insightHead",
			"poolChipLabel": "K1gtda_poolChipLabel",
			"cardTurn": "K1gtda_cardTurn",
			"awarenessDate": "K1gtda_awarenessDate",
			"stats": "K1gtda_stats",
			"pendingItem": "K1gtda_pendingItem",
			"confirmToggle": "K1gtda_confirmToggle",
			"recBody": "K1gtda_recBody",
			"viewKicker": "K1gtda_viewKicker",
			"footerHint": "K1gtda_footerHint",
			"mbtiDimRow": "K1gtda_mbtiDimRow",
			"toolbar": "K1gtda_toolbar",
			"settingsInstanceHead": "K1gtda_settingsInstanceHead",
			"spinner": "K1gtda_spinner",
			"statusDot": "K1gtda_statusDot",
			"settingsTab": "K1gtda_settingsTab",
			"pendingInterpretation": "K1gtda_pendingInterpretation",
			"drawerTitle": "K1gtda_drawerTitle",
			"settingsActions": "K1gtda_settingsActions",
			"drawerEmptyTitle": "K1gtda_drawerEmptyTitle",
			"pendingObservation": "K1gtda_pendingObservation",
			"contextBar": "K1gtda_contextBar",
			"awarenessList": "K1gtda_awarenessList",
			"savedToggle": "K1gtda_savedToggle",
			"activityTime": "K1gtda_activityTime",
			"interestDomain": "K1gtda_interestDomain",
			"recHeaderCopy": "K1gtda_recHeaderCopy",
			"chainSection": "K1gtda_chainSection",
			"insightEvidence": "K1gtda_insightEvidence",
			"probe": "K1gtda_probe",
			"dialogCard": "K1gtda_dialogCard",
			"recHeader": "K1gtda_recHeader",
			"drawerOverlay": "K1gtda_drawerOverlay",
			"probeDomain": "K1gtda_probeDomain",
			"badgeRow": "K1gtda_badgeRow",
			"pendingKind": "K1gtda_pendingKind",
			"subTab": "K1gtda_subTab",
			"barTrack": "K1gtda_barTrack",
			"awarenessItem": "K1gtda_awarenessItem",
			"drawerPanel": "K1gtda_drawerPanel",
			"delightActions": "K1gtda_delightActions",
			"settingsSavebar": "K1gtda_settingsSavebar",
			"contextObservation": "K1gtda_contextObservation",
			"questionInterpretation": "K1gtda_questionInterpretation",
			"barRow": "K1gtda_barRow",
			"domainWeight": "K1gtda_domainWeight",
			"drawerEmptySubtitle": "K1gtda_drawerEmptySubtitle",
			"badge": "K1gtda_badge",
			"starCount": "K1gtda_starCount",
			"dialogueTitle": "K1gtda_dialogueTitle",
			"spacer": "K1gtda_spacer",
			"obcSpin": "K1gtda_obcSpin",
			"bellBadge": "K1gtda_bellBadge",
			"watchToggle": "K1gtda_watchToggle",
			"contextValue": "K1gtda_contextValue",
			"poolChipValue": "K1gtda_poolChipValue",
			"settingsRow": "K1gtda_settingsRow",
			"drawerHeader": "K1gtda_drawerHeader",
			"pinnedFooter": "K1gtda_pinnedFooter",
			"header": "K1gtda_header",
			"stateBadge": "K1gtda_stateBadge",
			"recCoverText": "K1gtda_recCoverText",
			"activityLine": "K1gtda_activityLine",
			"platformTag": "K1gtda_platformTag",
			"settingsBack": "K1gtda_settingsBack",
			"settingsToastBar": "K1gtda_settingsToastBar",
			"llmInstance": "K1gtda_llmInstance",
			"delightKickerLine": "K1gtda_delightKickerLine",
			"brandTitle": "K1gtda_brandTitle",
			"activityFooter": "K1gtda_activityFooter",
			"poolChip": "K1gtda_poolChip",
			"delightHeader": "K1gtda_delightHeader",
			"llmInstanceMain": "K1gtda_llmInstanceMain",
			"starToggle": "K1gtda_starToggle",
			"chainHead": "K1gtda_chainHead",
			"actionButton": "K1gtda_actionButton",
			"recCover": "K1gtda_recCover",
			"insightConfidenceLabel": "K1gtda_insightConfidenceLabel",
			"contextRow": "K1gtda_contextRow",
			"delightPlatform": "K1gtda_delightPlatform",
			"llmBadge": "K1gtda_llmBadge",
			"chainEditor": "K1gtda_chainEditor",
			"drawerEmpty": "K1gtda_drawerEmpty",
			"footerItem": "K1gtda_footerItem",
			"empty": "K1gtda_empty",
			"messageActions": "K1gtda_messageActions",
			"mbtiDimPole": "K1gtda_mbtiDimPole",
			"delightTitle": "K1gtda_delightTitle",
			"settingsPanel": "K1gtda_settingsPanel",
			"settingsFieldRow": "K1gtda_settingsFieldRow",
			"contextLabel": "K1gtda_contextLabel",
			"chip": "K1gtda_chip",
			"profileCard": "K1gtda_profileCard",
			"questionCard": "K1gtda_questionCard",
			"expression": "K1gtda_expression",
			"delightComposer": "K1gtda_delightComposer",
			"cardBody": "K1gtda_cardBody",
			"starLabel": "K1gtda_starLabel",
			"settingsHeader": "K1gtda_settingsHeader",
			"dialogActions": "K1gtda_dialogActions",
			"delightCard": "K1gtda_delightCard",
			"awarenessRow": "K1gtda_awarenessRow",
			"cardMeta": "K1gtda_cardMeta",
			"loadMore": "K1gtda_loadMore",
			"dialogueAction": "K1gtda_dialogueAction",
			"delightText": "K1gtda_delightText",
			"footerToggle": "K1gtda_footerToggle",
			"card": "K1gtda_card",
			"dialogFields": "K1gtda_dialogFields",
			"loadingRow": "K1gtda_loadingRow",
			"feedbackStatus": "K1gtda_feedbackStatus",
			"dialogueKicker": "K1gtda_dialogueKicker",
			"chainName": "K1gtda_chainName",
			"turnSoul": "K1gtda_turnSoul",
			"dialogActionRow": "K1gtda_dialogActionRow",
			"delightScorePill": "K1gtda_delightScorePill",
			"insightTitle": "K1gtda_insightTitle",
			"mbtiDimPct": "K1gtda_mbtiDimPct",
			"interestTree": "K1gtda_interestTree",
			"error": "K1gtda_error",
			"moduleRoute": "K1gtda_moduleRoute",
			"awarenessHeader": "K1gtda_awarenessHeader",
			"llmInstanceList": "K1gtda_llmInstanceList",
			"recCard": "K1gtda_recCard",
			"iconButton": "K1gtda_iconButton",
			"profileSummary": "K1gtda_profileSummary",
			"topicBadge": "K1gtda_topicBadge",
			"dialogHead": "K1gtda_dialogHead",
			"starButton": "K1gtda_starButton",
			"action_reject": "K1gtda_action_reject",
			"awarenessItemDate": "K1gtda_awarenessItemDate",
			"delightHero": "K1gtda_delightHero",
			"llmInstanceName": "K1gtda_llmInstanceName",
			"updateRow": "K1gtda_updateRow",
			"settingsHint": "K1gtda_settingsHint",
			"pendingConfidence": "K1gtda_pendingConfidence",
			"chipRow": "K1gtda_chipRow",
			"thumb": "K1gtda_thumb",
			"dialogOverlay": "K1gtda_dialogOverlay",
			"chatInput": "K1gtda_chatInput",
			"pendingOpen": "K1gtda_pendingOpen",
			"sectionTitle": "K1gtda_sectionTitle",
			"turnUser": "K1gtda_turnUser",
			"recTitle": "K1gtda_recTitle",
			"body": "K1gtda_body",
			"cardActions": "K1gtda_cardActions",
			"statusText": "K1gtda_statusText",
			"commentInput": "K1gtda_commentInput",
			"profilePortraitP": "K1gtda_profilePortraitP",
			"settingsOverlay": "K1gtda_settingsOverlay",
			"delightNav": "K1gtda_delightNav",
			"delightThumbFallback": "K1gtda_delightThumbFallback",
			"mbtiDimBarFill": "K1gtda_mbtiDimBarFill",
			"messageTitle": "K1gtda_messageTitle",
			"questionObservation": "K1gtda_questionObservation",
			"probeStatus": "K1gtda_probeStatus",
			"sectionIcon": "K1gtda_sectionIcon",
			"delightReason": "K1gtda_delightReason",
			"probeHead": "K1gtda_probeHead",
			"tab": "K1gtda_tab",
			"dialogueState": "K1gtda_dialogueState",
			"settings": "K1gtda_settings",
			"settingsInstance": "K1gtda_settingsInstance",
			"sidebarButtonLabel": "K1gtda_sidebarButtonLabel",
			"thumbFallback": "K1gtda_thumbFallback",
			"interestDomainWeight": "K1gtda_interestDomainWeight"
		};
		//#endregion
