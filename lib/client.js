window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function createOpenBiliClawDrawerStore() {
		...
		*/
		...
		var panel_module_css_default = {
			...
			"drawerBackdrop": "_2AgH6G_drawerBackdrop",
		...
		*/
		function OpenBiliClawSidebarButton({ wide, useStore, actions }) {
		...
		*/
		function OpenBiliClawPanel({ closeDrawer, isDark, onThemeChange }) {
		...
		//#endregion
		//#region lib/types/client/drawer.js
		/**
		...
		*/
		function OpenBiliClawDrawer({ useStore, actions, isDark, onThemeChange }) {
			const open = useStore((s) => s.open);
			return (0, react_jsx_runtime.jsxs)("div", {
				className: panel_module_css_default.drawerRoot,
				"data-open": open || void 0,
				children: [(0, react_jsx_runtime.jsx)("div", {
					className: panel_module_css_default.drawerBackdrop,
					"aria-hidden": "true",
					onClick: () => {
						actions.close();
					}
				}), (0, react_jsx_runtime.jsx)("aside", {
					className: panel_module_css_default.drawer,
					"aria-label": "OpenBiliClaw",
					children: (0, react_jsx_runtime.jsx)(OpenBiliClawPanel, {
						closeDrawer: () => {
							actions.close();
						},
						isDark,
