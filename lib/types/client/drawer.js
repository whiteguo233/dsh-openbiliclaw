...
export function OpenBiliClawDrawer({ useStore, actions, isDark, onThemeChange }) {
    ...
    return (_jsx("div", { className: css.drawerRoot, "data-open": open || undefined, children: _jsx("aside", { className: css.drawer, "aria-label": "OpenBiliClaw", children: _jsx(OpenBiliClawPanel, { closeDrawer: () => { actions.close(); }, isDark: isDark, onThemeChange: onThemeChange }) }) }));
}
